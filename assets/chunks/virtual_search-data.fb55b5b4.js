...
console.log(uniqueA ...`,l:"JavaScript/core/duplicate.html#_1-使用-set",a:"_1-使用-set"},"69.2":{t:"2. for 循环\r",p:`const unique = (arr) =&gt; {
  ...
  const map = new Map()
  const res = []
  for (let i = 0; i &lt; arr.l ...`,l:"JavaScript/core/duplicate.html#_6-使用-map",a:"_6-使用-map"},"70.0":{t:"# Event Loop 事件循环机制\r",p:"\r",l:"JavaScript/core/eventLoop.html",a:"event-loop-事件循环机制"},"70.1":{t:"js 事件执行机制的过程\r",p:`javaScript 是一门单线程语言，js 在执行代码时会按照代码语句的顺序执行形成一个执行栈，默认会从上到下依次执行，执行过程中会将任务分成两类。

同步任务：需要执行的任务在主线程上排队，一次执 ...`,l:"JavaScript/core/eventLoop.html#js-事件执行机制的过程",a:"js-事件执行机制的过程"},"70.2":{t:"异步任务分为：宏任务和微任务\r",p:`同步和异步分别进入到不同的执行场所，同步进入到主线程，异步的进入到任务队列（event table） 并注册函数，异步任务又可以分为宏任务和微任务。

微任务： process.nextTick（no ...`,l:"JavaScript/core/eventLoop.html#异步任务分为-宏任务和微任务",a:"异步任务分为-宏任务和微任务"},"70.3":{t:"事件循环顺序\r",p:`
...
当前微任务执行完后，判断是否有 UI 渲染如果有 ...`,l:"JavaScript/core/eventLoop.html#事件循环顺序",a:"事件循环顺序"},"70.4":{t:" ",p:"",l:"JavaScript/core/eventLoop.html#",a:""},"70.5":{t:"例子 -->",p:"",l:"JavaScript/core/eventLoop.html#例子",a:"例子"},"71.0":{t:"# 数组扁平化\r",p:`
数组扁平化是指将一个多维数组变为一个一维数组

const arr = [1, [2, [3, [4, 5]]], 6]
// =&gt; [1, 2, 3, 4, 5, 6]

`,l:"JavaScript/core/flattening.html",a:"数组扁平化"},"71.1":{t:"1. 使用 flat()\r",p:`const res1 = arr.flat()
// 使用Infinity，无论多少层都将扁平化为一维数组。
const res1 = arr.flat(Infinity)

`,l:"JavaScript/core/flattening.html#_1-使用-flat",a:"_1-使用-flat"},"71.2":{t:"2. 利用正则\r",p:`const res2 = JSON.stringify(arr).replace(/\\[|\\]/g, '').split(',')

// 优化
const res3 = JSON.parse('[' ...`,l:"JavaScript/core/flattening.html#_2-利用正则",a:"_2-利用正则"},"71.3":{t:"3. 使用 reduce\r",p:`const flatten = (arr) =&gt; {
  return arr.reduce((pre, cur) =&gt; {
    return pre.concat(Array.isA ...`,l:"JavaScript/core/flattening.html#_3-使用-reduce",a:"_3-使用-reduce"},"71.4":{t:"4. 函数递归\r",p:`const res5 = []
const fn = (arr) =&gt; {
  for (let i = 0; i &lt; arr.length; i++) {
    if (Array.i ...`,l:"JavaScript/core/flattening.html#_4-函数递归",a:"_4-函数递归"},"72.0":{t:"# JavaScript Promise\r",p:`Promise是一种异步编程的解决方案，它可以避免回调地狱，使代码更加简洁易读。Promise对象代表一个异步操作的最终完成或失败，并返回一个值。
在 JavaScript 中，Promise有三种状 ...`,l:"JavaScript/core/promise.html",a:"javascript-promise"},"72.1":{t:"创建 Promise\r",p:`Promise 可以通过 new Promise() 构造函数来创建。它接收一个带有两个参数的回调函数，回调函数包含两个参数：resolve 和 reject。
const promise = new ...`,l:"JavaScript/core/promise.html#创建-promise",a:"创建-promise"},"72.2":{t:"处理 Promise 结果\r",p:`通过调用 Promise 实例的 .then() 方法可以处理异步操作成功的结果，通过调用 .catch() 方法可以处理异步操作失败的结果。
promise
  .then((value) =&gt ...`,l:"JavaScript/core/promise.html#处理-promise-结果",a:"处理-promise-结果"},"72.3":{t:"Promise 链式调用\r",p:`Promise 的一个重要特性是可以通过链式调用来串联多个异步操作。通过在 .then() 方法中返回新的 Promise 实例，可以将多个异步操作连接起来。
promise
  .then((val ...`,l:"JavaScript/core/promise.html#promise-链式调用",a:"promise-链式调用"},"72.4":{t:"Promise.all()\r",p:"Promise.all() 方法接收一个 Promise 实例数组，返回一个新的 Promise 实例。该新实例在数组中的所有 Promise 实例都成功完成时才会成功，并将所有 Promise 实例 ...",l:"JavaScript/core/promise.html#promise-all",a:"promise-all"},"72.5":{t:"使用 `Promise` 封装一个 Ajax\r",p:`下面是一个使用 Promise 封装的基本 Ajax 请求的示例：
function ajax(url, method, data) {
  return new Promise((resolve,  ...`,l:"JavaScript/core/promise.html#使用-promise-封装一个-ajax",a:"使用-promise-封装一个-ajax"},"73.0":{t:"# JavaScript 原型\r",p:"\r",l:"JavaScript/core/prototype.html",a:"javascript-原型"},"73.1":{t:"原型\r",p:`原型是 JavaScript 中每个对象的基础。每个 JavaScript 对象都有一个原型对象，它是一个包含属性和方法的对象。这个原型对象可以被其他对象继承，从而实现属性和方法的共享。
在 Java ...`,l:"JavaScript/core/prototype.html#原型",a:"原型"},"73.2":{t:"原型链\r",p:`原型链是一个对象和它的原型对象之间的连接。当你访问一个对象的属性或方法时，JavaScript 会首先查找该对象本身是否有这个属性或方法，如果没有，它会沿着原型链向上查找，直到找到为止。
functi ...`,l:"JavaScript/core/prototype.html#原型链",a:"原型链"},"73.3":{t:"原型对象\r",p:`每个 JavaScript 对象都有一个关联的原型对象。你可以通过 __proto__ 属性来访问对象的原型对象。例如：
const person = { name: 'John' }
console ...`,l:"JavaScript/core/prototype.html#原型对象",a:"原型对象"},"73.4":{t:"原型继承\r",p:`原型继承是 JavaScript 中对象之间共享属性和方法的一种方式。当一个对象继承了另一个对象的原型时，它可以访问该原型对象上的属性和方法。
让我们再次看一个例子：
function Animal( ...`,l:"JavaScript/core/prototype.html#原型继承",a:"原型继承"},"73.5":{t:"JavaScript 中的原型继承方式\r",p:`JavaScript 中有多种方式来实现原型继承，让我们一一了解这些方式。
`,l:"JavaScript/core/prototype.html#javascript-中的原型继承方式",a:"javascript-中的原型继承方式"},"73.6":{t:"1. 构造函数和原型链\r",p:`这是最常见的原型继承方式。它使用构造函数来创建对象属性，同时使用原型链来共享方法。在前面的例子中，我们已经看到了这种方式的示例。
function Animal(name) {
  this.name ...`,l:"JavaScript/core/prototype.html#_1-构造函数和原型链",a:"_1-构造函数和原型链"},"73.7":{t:"2. Object.create()\r",p:`Object.create() 方法是一种更简单的方式来创建一个对象并指定其原型。它接受一个原型对象作为参数，然后返回一个新对象，该对象的原型就是传入的原型对象。
const animal = {
  ...`,l:"JavaScript/core/prototype.html#_2-object-create",a:"_2-object-create"},"73.8":{t:"3. 类继承\r",p:`ES6 引入了类（class）的概念，它提供了一种更简单的方式来实现原型继承。类可以使用 extends 关键字继承另一个类的属性和方法。
class Animal {
  constructor(n ...`,l:"JavaScript/core/prototype.html#_3-类继承",a:"_3-类继承"},"73.9":{t:"4. Object.setPrototypeOf()\r",p:`Object.setPrototypeOf() 方法允许你在运行时更改对象的原型。这个方法接受两个参数：要更改原型的对象和新的原型对象。
const animal = {
  eat: functio ...`,l:"JavaScript/core/prototype.html#_4-object-setprototypeof",a:"_4-object-setprototypeof"},"73.10":{t:"原型继承与传统继承的区别\r",p:`JavaScript 中的原型继承与传统面向对象编程语言中的继承有一些重要区别。以下是一些主要区别：
`,l:"JavaScript/core/prototype.html#原型继承与传统继承的区别",a:"原型继承与传统继承的区别"},"73.11":{t:"1. 动态性\r",p:`JavaScript 的原型继承是动态的，这意味着你可以在运行时更改对象的原型。这种灵活性可以带来很多优势，但也需要小心使用，以避免不必要的复杂性。
`,l:"JavaScript/core/prototype.html#_1-动态性",a:"_1-动态性"},"73.12":{t:"2. 原型链\r",p:`JavaScript 中的继承是通过原型链来实现的，这意味着一个对象可以继承多个原型对象的属性和方法。这种多重继承的能力是传统继承中不常见的。
`,l:"JavaScript/core/prototype.html#_2-原型链",a:"_2-原型链"},"73.13":{t:"3. 对象与类\r",p:`传统面向对象编程语言通常使用类来定义对象的结构和行为，而 JavaScript 使用构造函数和原型对象。这种不同的方式可以导致不同的编程风格和理念。
`,l:"JavaScript/core/prototype.html#_3-对象与类",a:"_3-对象与类"},"73.14":{t:"使用原型的最佳实践\r",p:`在使用原型时，有一些最佳实践可以帮助你编写更清晰、更可维护的代码：
`,l:"JavaScript/core/prototype.html#使用原型的最佳实践",a:"使用原型的最佳实践"},"73.15":{t:"1. 避免直接修改内建对象的原型\r",p:`虽然你可以修改内建对象的原型，但最好不要这样做，因为它可能会导致意外的行为和不稳定性。如果需要扩展内建对象的功能，可以创建一个自定义的工具函数或对象，而不是修改原型。
`,l:"JavaScript/core/prototype.html#_1-避免直接修改内建对象的原型",a:"_1-避免直接修改内建对象的原型"},"73.16":{t:"2. 将方法添加到原型上\r",p:`将方法添加到原型上而不是在构造函数内部定义方法，可以节省内存，因为所有对象实例共享同一个方法。这样可以降低内存使用，特别是当有大量对象实例时。
`,l:"JavaScript/core/prototype.html#_2-将方法添加到原型上",a:"_2-将方法添加到原型上"},"73.17":{t:"3. 注意原型链中的属性和方法覆盖\r",p:`当在子对象上定义与父对象相同名称的属性或方法时，它会覆盖父对象上的属性或方法。因此，在命名属性和方法时要小心，以避免不必要的覆盖。
`,l:"JavaScript/core/prototype.html#_3-注意原型链中的属性和方法覆盖",a:"_3-注意原型链中的属性和方法覆盖"},"73.18":{t:"4. 使用 Object.create()来创建对象\r",p:`Object.create() 方法提供了一种更灵活的方式来创建对象，并指定其原型。它可以帮助你更清晰地定义对象之间的继承关系。
`,l:"JavaScript/core/prototype.html#_4-使用-object-create-来创建对象",a:"_4-使用-object-create-来创建对象"},"74.0":{t:"# 详解数组中的 reduce 方法\r",p:`reduce()是 JavaScript 数组的一个高阶函数，它用于对数组中的元素进行累积操作，将数组缩减为单个值。
通过reduce()方法，我们可以对数组中的每个元素进行自定义的累积运算，最终得到 ...`,l:"JavaScript/core/reduce.html",a:"详解数组中的-reduce-方法"},"74.1":{t:"语法如下\r",p:`array.reduce(callbackfn, initialValue)


callbackfn 是回调函数，它接受四个参数：前一个值（prev）、当前值（currentValue）、当前索引（ ...`,l:"JavaScript/core/reduce.html#语法如下",a:"语法如下"},"74.2":{t:"示例\r",p:"\r",l:"JavaScript/core/reduce.html#示例",a:"示例"},"74.3":{t:"（1）计算数组累积结果\r",p:`
演示如何使用reduce()方法来计算数组中所有元素的和：

const numbers = [1, 2, 3, 4]

const sum = numbers.reduce((prev, cur) ...`,l:"JavaScript/core/reduce.html#_1-计算数组累积结果",a:"_1-计算数组累积结果"},"74.4":{t:"（2）计算数组中每个元素出现的次数\r",p:`var arr = ['one', 'two', 'two', 'three', 'two', 'six', 'four', 'five', 'four', 'six']

var newArr =  ...`,l:"JavaScript/core/reduce.html#_2-计算数组中每个元素出现的次数",a:"_2-计算数组中每个元素出现的次数"},"74.5":{t:"（3）数组去重\r",p:`let arr = [1, 2, 3, 4, 4, 1]
let newArr = arr.reduce((pre, cur) =&gt; {
  if (!pre.includes(cur)) {
 ...`,l:"JavaScript/core/reduce.html#_3-数组去重",a:"_3-数组去重"},"74.6":{t:"（4）数组扁平化 二维转一维\r",p:`let arr = [
  [0, 1],
  [2, 3],
  [4, 5]
]
let newArr = arr.reduce((pre, cur) =&gt; {
  return pre.c ...`,l:"JavaScript/core/reduce.html#_4-数组扁平化-二维转一维",a:"_4-数组扁平化-二维转一维"},"74.7":{t:"（5）数组扁平化 多维转一维\r",p:`let arr = [
  [0, 1],
  [2, 3],
  [4, [5, 6, 7]]
]
const newArr = function (arr) {
  return arr.redu ...`,l:"JavaScript/core/reduce.html#_5-数组扁平化-多维转一维",a:"_5-数组扁平化-多维转一维"},"74.8":{t:"（6）对象属性求和\r",p:`var result = [
  {
    subject: 'math',
    score: 10
  },
  {
    subject: 'chinese',
    score: 20 ...`,l:"JavaScript/core/reduce.html#_6-对象属性求和",a:"_6-对象属性求和"},"74.9":{t:"注意事项\r",p:`::: tip 注意


reduce()方法适用于对数组的每个元素执行同一个累积操作，并将结果返回为单个值的情况。


在使用reduce()方法时，建议始终提供initialValue来明确指定累 ...`,l:"JavaScript/core/reduce.html#注意事项",a:"注意事项"},"75.0":{t:"# JavaScript 作用域\r",p:`作用域是指变量和函数在代码中可访问的范围。JavaScript 中有两种主要的作用域类型：全局作用域和局部作用域。
`,l:"JavaScript/core/scope.html",a:"javascript-作用域"},"75.1":{t:"全局作用域\r",p:`全局作用域是指在代码的任何地方都可访问的变量和函数。在全局作用域中声明的变量和函数可以被代码中的任何地方访问。
var globalVariable = 'Global'

function glob ...`,l:"JavaScript/core/scope.html#全局作用域",a:"全局作用域"},"75.2":{t:"局部作用域\r",p:`局部作用域是指在特定代码块（如函数、循环或条件语句）内部声明的变量和函数。这些变量和函数只能在其声明的代码块内部访问。
function outerFunction() {
  var outerVa ...`,l:"JavaScript/core/scope.html#局部作用域",a:"局部作用域"},"75.3":{t:"作用域链\r",p:"作用域链是指 JavaScript 引擎在查找变量时的嵌套作用域链条。当访问一个变量时，JavaScript 引擎首先在当前作用域的变量对象中查找，如果找不到，就会向上一级作用域继续查找，直到找到该变 ...",l:"JavaScript/core/scope.html#作用域链",a:"作用域链"},"75.4":{t:"词法作用域\r",p:`JavaScript 中的作用域是通过代码的结构和位置来确定的，而不是通过运行时的状态。这被称为词法作用域。函数在定义时就确定了自己的作用域，而不是在调用时。
var variable = 'Glob ...`,l:"JavaScript/core/scope.html#词法作用域",a:"词法作用域"},"76.0":{t:"# DOM 节点\r",p:"\r",l:"JavaScript/DOM/DOM节点.html",a:"dom-节点"},"76.1":{t:"插入节点\r",p:`在已有的 DOM 节点中插入新的 DOM 节点时，需要关注两个关键因素：首先要得到新的 DOM 节点，其次在哪个位置插入这个节点。


createElement 动态创建任意 DOM 节点


cl ...`,l:"JavaScript/DOM/DOM节点.html#插入节点",a:"插入节点"},"76.2":{t:"删除节点\r",p:`删除现有的 DOM 节点，也需要关注两个因素：首先由父节点删除子节点，其次是要删除哪个子节点。
removeChild 删除节点时一定是由父子关系。
&lt;body&gt;
  &lt;!-- 点击 ...`,l:"JavaScript/DOM/DOM节点.html#删除节点",a:"删除节点"},"76.3":{t:"查找节点\r",p:`DOM 树中的任意节点都不是孤立存在的，它们要么是父子关系，要么是兄弟关系，不仅如此，我们可以依据节点之间的关系查找节点。
`,l:"JavaScript/DOM/DOM节点.html#查找节点",a:"查找节点"},"76.4":{t:"父子关系\r",p:`
childNodes 获取全部的子节点，回车换行会被认为是空白文本节点
children 只获取元素类型节点

&lt;body&gt;
  &lt;button class=&quot;btn1& ...`,l:"JavaScript/DOM/DOM节点.html#父子关系",a:"父子关系"},"76.5":{t:"兄弟关系\r",p:`
previousSibling 获取前一个节点，以相对位置查找节点，实际应用中非常灵活。
nextSibling 获取后一个节点，以相对位置查找节点，实际应用中非常灵活。

&lt;body&gt; ...`,l:"JavaScript/DOM/DOM节点.html#兄弟关系",a:"兄弟关系"},"77.0":{t:"# JavaScript DOM\r",p:"\r",l:"JavaScript/DOM/index.html",a:"javascript-dom"},"77.1":{t:"概念\r",p:"DOM（Document Object Model）是一种用于表示和操作 HTML、XML 等文档结构的编程接口。它将文档表示为一个树状结构，每个节点都是文档中的一个元素、属性、文本或其他类型的内容。 ...",l:"JavaScript/DOM/index.html#概念",a:"概念"},"77.2":{t:"DOM 树\r",p:`&lt;!DOCTYPE html&gt;
&lt;html lang=&quot;en&quot;&gt;
  &lt;head&gt;
    &lt;meta charset=&quot;UTF ...`,l:"JavaScript/DOM/index.html#dom-树",a:"dom-树"},"77.3":{t:"DOM 节点\r",p:`节点是文档树的组成部分，每一个节点都是一个 DOM 对象，主要分为元素节点、属性节点、文本节点等。

【元素节点】其实就是 HTML 标签，如上图中 head、div、body 等都属于元素节点。
【 ...`,l:"JavaScript/DOM/index.html#dom-节点",a:"dom-节点"},"77.4":{t:"document\r",p:`document 是 JavaScript 内置的专门用于 DOM 的对象，该对象包含了若干的属性和方法，document 是学习 DOM 的核心。


::: tip
DOM 提供了丰富的功能和方法 ...`,l:"JavaScript/DOM/index.html#document",a:"document"},"78.0":{t:"# DOM 事件处理\r",p:`DOM 事件处理是 JavaScript 中常用的一项功能，它允许你监听和响应用户与网页元素之间的交互。下面是一些常见的方法和技巧来处理 DOM 事件：
`,l:"JavaScript/DOM/事件处理.html",a:"dom-事件处理"},"78.1":{t:"事件\r",p:`事件是编程语言中的术语，它是用来描述程序的行为或状态的，一旦行为或状态发生改变，便立即调用一个函数。
例如：用户使用【鼠标点击】网页中的一个按钮、用户使用【鼠标拖拽】网页中的一张图片
`,l:"JavaScript/DOM/事件处理.html#事件",a:"事件"},"78.2":{t:"事件监听\r",p:`::: tip
结合 DOM 使用事件时，需要为 DOM 对象添加事件监听，等待事件发生（触发）时，便立即调用一个函数。
addEventListener 是 DOM 对象专门用来添加事件监听的方法， ...`,l:"JavaScript/DOM/事件处理.html#事件监听",a:"事件监听"},"78.3":{t:"事件移除\r",p:`当我们不再需要一个事件监听器时，应该将其从元素上移除，以避免不必要的事件处理。可以使用以下方法来移除事件监听器：
element.removeEventListener('eventName', ev ...`,l:"JavaScript/DOM/事件处理.html#事件移除",a:"事件移除"},"78.4":{t:"事件类型\r",p:"\r",l:"JavaScript/DOM/事件处理.html#事件类型",a:"事件类型"},"78.5":{t:"鼠标事件\r",p:`鼠标事件是指跟鼠标操作相关的事件，如单击、双击、移动等。
...
mousedown
 ...`,l:"JavaScript/DOM/事件处理.html#鼠标事件",a:"鼠标事件"},"78.6":{t:"键盘事件\r",p:`const input = document.querySelector('input')
// 1. 键盘事件
// input.addEventListener('keydown', functi ...`,l:"JavaScript/DOM/事件处理.html#键盘事件",a:"键盘事件"},"78.7":{t:"焦点事件\r",p:`const input = document.querySelector('input')
input.addEventListener('focus', function () {
  consol ...`,l:"JavaScript/DOM/事件处理.html#焦点事件",a:"焦点事件"},"78.8":{t:"文本框输入事件\r",p:`
input 事件：当用户在文本框中输入、删除或修改文本时触发。无论是键盘输入、粘贴、剪切还是使用其他输入方法，只要文本框内容发生变化，就会触发 input 事件。
change 事件：当文本框内容发 ...`,l:"JavaScript/DOM/事件处理.html#文本框输入事件",a:"文本框输入事件"},"78.9":{t:"事件对象\r",p:`
事件处理程序的第一个参数是事件对象 event，它包含有关事件的信息，例如事件类型、目标元素等。你可以在事件处理程序中使用这些信息来执行逻辑操作。

const btn = document.que ...`,l:"JavaScript/DOM/事件处理.html#事件对象",a:"事件对象"},"78.10":{t:"事件冒泡和事件捕获\r",p:`
事件冒泡：默认情况下，事件会从触发它的元素向上冒泡到祖先元素。你可以使用 event.stopPropagation() 方法来停止事件冒泡。

&lt;body&gt;
  &lt;h3&gt;事 ...`,l:"JavaScript/DOM/事件处理.html#事件冒泡和事件捕获",a:"事件冒泡和事件捕获"},"78.11":{t:"常见事件类型\r",p:`以下是一些常见的 DOM 事件类型：
...
表 ...`,l:"JavaScript/DOM/事件处理.html#常见事件类型",a:"常见事件类型"},"78.12":{t:"事件委托\r",p:"JavaScript 事件委托是一种利用事件冒泡原理来简化事件处理的技术。通过将事件监听器绑定到一个父元素上，然后利用事件冒泡机制，从父元素中捕获和处理子元素触发的事件。这样可以减少事件处理程序的数量 ...",l:"JavaScript/DOM/事件处理.html#事件委托",a:"事件委托"},"79.0":{t:"# DOM 创建和操作元素\r",p:`
createElement(): 创建新的元素节点。
appendChild(): 将一个节点添加为另一个节点的子节点。
removeChild(): 删除指定的子节点。
setAttribute( ...`,l:"JavaScript/DOM/创建和操作元素.html",a:"dom-创建和操作元素"},"79.1":{t:"创建元素\r",p:`使用 createElement 方法创建新元素：
const newElement = document.createElement('tagName')

其中 tagName 是你想要创建的元素 ...`,l:"JavaScript/DOM/创建和操作元素.html#创建元素",a:"创建元素"},"79.2":{t:"设置元素属性和内容\r",p:`设置元素的属性：使用 setAttribute 方法：
element.setAttribute('attributeName', 'attributeValue')

设置元素的文本内容：使用 te ...`,l:"JavaScript/DOM/创建和操作元素.html#设置元素属性和内容",a:"设置元素属性和内容"},"79.3":{t:"操作元素的父子关系\r",p:`将新元素添加到父元素中：使用 appendChild 方法：
parentElement.appendChild(newElement)

这将把 newElement 添加为 parentEleme ...`,l:"JavaScript/DOM/创建和操作元素.html#操作元素的父子关系",a:"操作元素的父子关系"},"80.0":{t:"# DOM 样式和类操作\r",p:`在 JavaScript 中，可以使用 DOM（文档对象模型）来操作元素的样式和类。以下是一些常用的方法和技巧：
`,l:"JavaScript/DOM/样式和类操作.html",a:"dom-样式和类操作"},"80.1":{t:"样式操作\r",p:`

修改元素的内联样式：使用 style 对象来访问和修改元素的样式属性。
element.style.backgroundColor = 'red'

这里的 backgroundColor 是你要 ...`,l:"JavaScript/DOM/样式和类操作.html#样式操作",a:"样式操作"},"80.2":{t:"类操作\r",p:`
...
移除类名：使用 classList 属性的 remove 方 ...`,l:"JavaScript/DOM/样式和类操作.html#类操作",a:"类操作"},"81.0":{t:"# DOM 获取和修改元素\r",p:`
getElementById(): 根据元素的 ID 获取元素节点。
getElementsByClassName(): 根据类名获取元素节点集合。
getElementsByTagName():  ...`,l:"JavaScript/DOM/获取和修改元素.html",a:"dom-获取和修改元素"},"81.1":{t:"获取元素\r",p:`通过 ID 获取元素：使用 getElementById 方法，传入元素的 ID。
const element = document.getElementById('elementId')

通过类名 ...`,l:"JavaScript/DOM/获取和修改元素.html#获取元素",a:"获取元素"},"81.2":{t:"修改元素\r",p:`修改元素的文本内容：使用 textContent 属性或 innerText 属性。
element.textContent = 'New content'

// 或者
element.innerT ...`,l:"JavaScript/DOM/获取和修改元素.html#修改元素",a:"修改元素"},"82.0":{t:"# JavaScript Cookie\r",p:"Cookie 是一种在客户端浏览器上存储数据的机制，允许开发者在用户计算机中存储和检索有关网站的信息。Cookie 是由服务器发送到浏览器的小型文本文件，然后浏览器会将 Cookie 存储在用户的计算 ...",l:"JavaScript/storage/cookie.html",a:"javascript-cookie"},"82.1":{t:"设置 Cookie\r",p:`可以使用 document.cookie 属性来设置 Cookie。document.cookie 属性是一个字符串，包含一个或多个以分号分隔的键值对。
document.cookie = 'user ...`,l:"JavaScript/storage/cookie.html#设置-cookie",a:"设置-cookie"},"82.2":{t:"获取 Cookie\r",p:`可以使用 document.cookie 属性来获取存储在浏览器中的所有 Cookie。
var cookies = document.cookie
console.log(cookies)

doc ...`,l:"JavaScript/storage/cookie.html#获取-cookie",a:"获取-cookie"},"82.3":{t:"删除 Cookie\r",p:`可以通过将 Cookie 的过期时间设置为过去的时间来删除 Cookie。
document.cookie = 'username=; expires=Thu, 01 Jan 1970 00:00:0 ...`,l:"JavaScript/storage/cookie.html#删除-cookie",a:"删除-cookie"},"82.4":{t:"注意事项\r",p:`

每个域名下的 Cookie 是相互独立的，不同域名之间的 Cookie 是隔离的。


document.cookie 返回的是一个字符串，包含当前域名下的所有 Cookie。需要自行解析和处理字 ...`,l:"JavaScript/storage/cookie.html#注意事项",a:"注意事项"},"83.0":{t:"# JavaScript localStorage\r",p:"localStorage 是 Web Storage API 提供的一种本地存储机制，允许开发者在浏览器中存储和检索持久化的键值对数据。与 sessionStorage 不同，localStorage ...",l:"JavaScript/storage/localStorage.html",a:"javascript-localstorage"},"83.1":{t:"存储数据\r",p:"可以使用 localStorage.setItem(key, value) 方法将数据存储到 localStorage 中。其中，key 是要存储的数据的键，value 是对应的值。存储的值必须是字符 ...",l:"JavaScript/storage/localStorage.html#存储数据",a:"存储数据"},"83.2":{t:"获取数据\r",p:`可以使用 localStorage.getItem(key) 方法根据键从 localStorage 中检索数据。如果键不存在，返回 null。
var username = localStorage ...`,l:"JavaScript/storage/localStorage.html#获取数据",a:"获取数据"},"83.3":{t:"更新数据\r",p:`可以通过重新设置相同的键来更新 localStorage 中的数据。
localStorage.setItem('age', '26')

`,l:"JavaScript/storage/localStorage.html#更新数据",a:"更新数据"},"83.4":{t:"删除数据\r",p:`可以使用 localStorage.removeItem(key) 方法来删除指定键的数据。
localStorage.removeItem('age')

`,l:"JavaScript/storage/localStorage.html#删除数据",a:"删除数据"},"83.5":{t:"清除所有数据\r",p:`可以使用 localStorage.clear() 方法来删除 localStorage 中的所有数据。
localStorage.clear()

`,l:"JavaScript/storage/localStorage.html#清除所有数据",a:"清除所有数据"},"83.6":{t:"注意事项\r",p:`
localStorage 存储的值必须是字符串类型。如果需要存储其他数据类型（如对象或数组），可以使用 JSON.stringify() 方法将其转换为字符串存储，然后在需要时使用 JSON.par ...`,l:"JavaScript/storage/localStorage.html#注意事项",a:"注意事项"},"84.0":{t:"# JavaScript sessionStorage\r",p:"sessionStorage 是 Web Storage API 提供的一种本地存储机制，允许开发者在浏览器中存储和检索会话级别的键值对数据。与 localStorage 不同，sessionStor ...",l:"JavaScript/storage/sessionStorage.html",a:"javascript-sessionstorage"},"84.1":{t:"存储数据\r",p:"可以使用 sessionStorage.setItem(key, value) 方法将数据存储到 sessionStorage 中。其中，key 是要存储的数据的键，value 是对应的值。存储的值必 ...",l:"JavaScript/storage/sessionStorage.html#存储数据",a:"存储数据"},"84.2":{t:"获取数据\r",p:`可以使用 sessionStorage.getItem(key) 方法根据键从 sessionStorage 中检索数据。如果键不存在，返回 null。
var username = sessionS ...`,l:"JavaScript/storage/sessionStorage.html#获取数据",a:"获取数据"},"84.3":{t:"更新数据\r",p:`可以通过重新设置相同的键来更新 sessionStorage 中的数据。
sessionStorage.setItem('age', '26')

`,l:"JavaScript/storage/sessionStorage.html#更新数据",a:"更新数据"},"84.4":{t:"删除数据\r",p:`可以使用 sessionStorage.removeItem(key) 方法来删除指定键的数据。
sessionStorage.removeItem('age')

`,l:"JavaScript/storage/sessionStorage.html#删除数据",a:"删除数据"},"84.5":{t:"清除所有数据\r",p:`可以使用 sessionStorage.clear() 方法来删除 sessionStorage 中的所有数据。
sessionStorage.clear()

`,l:"JavaScript/storage/sessionStorage.html#清除所有数据",a:"清除所有数据"},"84.6":{t:"注意事项\r",p:`
sessionStorage 存储的值必须是字符串类型。如果需要存储其他数据类型（如对象或数组），可以使用 JSON.stringify() 方法将其转换为字符串存储，然后在需要时使用 JSON.p ...`,l:"JavaScript/storage/sessionStorage.html#注意事项",a:"注意事项"},"85.0":{t:"# 内置对象 Date\r",p:"\r",l:"JavaScript/内置对象/Date.html",a:"内置对象-date"},"85.1":{t:"Date 方法\r",p:`
...
getDay()
获取星期几，返回值为 0（表示星期日）到 6（表示星期六）之间的整数 ...`,l:"JavaScript/内置对象/Date.html#date-方法",a:"date-方法"},"85.2":{t:"创建日期\r",p:`Date 对象用于处理日期和时间。
可以通过 new 关键词来定义 Date 对象。以下代码定义了名为 myDate 的 Date 对象：
有四种方式初始化日期:
new Date();
new Da ...`,l:"JavaScript/内置对象/Date.html#创建日期",a:"创建日期"},"85.3":{t:"设置日期\r",p:`通过使用针对日期对象的方法，我们可以很容易地对日期进行操作。
在下面的例子中，我们为日期对象设置了一个特定的日期 (2050 年 1 月 10 日)：
var myDate = new Date()
 ...`,l:"JavaScript/内置对象/Date.html#设置日期",a:"设置日期"},"85.4":{t:"时间戳\r",p:`时间戳是指 1970 年 01 月 01 日 00 时 00 分 00 秒起至现在的总秒数或毫秒数，它是一种特殊的计量时间的方式。

注：ECMAScript 中时间戳是以毫秒计的。

获取时间戳的方 ...`,l:"JavaScript/内置对象/Date.html#时间戳",a:"时间戳"},"85.5":{t:"两个日期比较\r",p:`var x = new Date()
x.setFullYear(2100, 0, 14)
var today = new Date()

if (x &gt; today) {
  alert('今 ...`,l:"JavaScript/内置对象/Date.html#两个日期比较",a:"两个日期比较"},"86.0":{t:"# JavaScript 内置对象\r",p:`内置对象：就是指这个语言自带的一些对象，供开发者使用，这些对象提供了一些常用或者基本而必要的功能（属性和方法），用于处理各种不同类型的数据和操作。
::: tip 简介
JavaScript 的内置对 ...`,l:"JavaScript/内置对象/index.html",a:"javascript-内置对象"},"86.1":{t:"JavaScript 的内置对象：\r",p:`
...
Ma ...`,l:"JavaScript/内置对象/index.html#javascript-的内置对象",a:"javascript-的内置对象"},"86.2":{t:"Object\r",p:`Object 是 JavaScript 的基础对象，其他对象都继承自它。Object 提供了一系列通用的方法，如对象的创建、属性的设置和获取等。它是构建其他对象的基石。
`,l:"JavaScript/内置对象/index.html#object",a:"object"},"86.3":{t:"Array\r",p:`Array 是用于表示和操作数组的对象。它提供了一系列的方法来操作和处理数据集合，如添加、删除、查询、排序等。Array 的灵活性使得它在处理列表和集合数据时非常便利。
`,l:"JavaScript/内置对象/index.html#array",a:"array"},"86.4":{t:"String\r",p:`String 是用于表示和操作字符串的对象。它提供了许多字符串相关的方法，如拼接、查找、替换等。这些方法可以帮助我们处理文本数据，进行字符串操作和处理。
`,l:"JavaScript/内置对象/index.html#string",a:"string"},"86.5":{t:"Number\r",p:`Number 是用于表示和操作数字的对象。它提供了一系列数字相关的方法，如四舍五入、转换为字符串、计算等。Number 可以进行基本的数学计算，还可以用于日期和时间处理。
`,l:"JavaScript/内置对象/index.html#number",a:"number"},"86.6":{t:"Boolean\r",p:`Boolean 是表示和操作布尔值的对象，包括 true 和 false 两个值。它提供了逻辑运算和条件判断的功能，用于控制流程和决策。
`,l:"JavaScript/内置对象/index.html#boolean",a:"boolean"},"86.7":{t:"Date\r",p:`Date 是用于表示日期和时间的对象。它提供了一系列的方法来操作日期和时间，如获取当前时间、设置时间、格式化等。Date 可以用于处理时间相关的任务，如计算时间差、添加或减去日期等。
`,l:"JavaScript/内置对象/index.html#date",a:"date"},"86.8":{t:"Math\r",p:`Math 是用于进行数学计算的对象。它提供了一系列数学运算方法，如求绝对值、计算平方根、生成随机数等。Math 可以用于复杂的数值计算和处理。
`,l:"JavaScript/内置对象/index.html#math",a:"math"},"86.9":{t:"RegExp\r",p:`RegExp 是用于进行正则表达式匹配的对象。它提供了一系列与正则表达式相关的方法，如匹配、替换等。RegExp 可以用于文本匹配、分割、替换等复杂的文本处理任务。
除了上述常用的内置对象外，还有一些 ...`,l:"JavaScript/内置对象/index.html#regexp",a:"regexp"},"87.0":{t:"# 内置对象 Math\r",p:"Math是JavaScript的一个内置对象，它提供了一些数学属性和方法，可以对数字进行计算（用于 Number 类型）。 Math和其他全局对象不同，它不是一个构造器，Math的所有方法和属性都是静 ...",l:"JavaScript/内置对象/Math.html",a:"内置对象-math"},"87.1":{t:"属性\r",p:`
Math.PI，获取圆周率

// 圆周率
console.log(Math.PI)

`,l:"JavaScript/内置对象/Math.html#属性",a:"属性"},"87.2":{t:"方法\r",p:"\r",l:"JavaScript/内置对象/Math.html#方法",a:"方法"},"87.3":{t:"Math.abs()\r",p:`Math.abs()函数，返回一个数的绝对值
Math.abs(-10)
// 10

`,l:"JavaScript/内置对象/Math.html#math-abs",a:"math-abs"},"87.4":{t:"Math.random()\r",p:`Math.random()函数，返回一个浮点，伪随机数范围从 0 到小于 1，从 0 往上不包括 1。
// 0 ~ 1 之间的随机数, 包含 0 不包含 1
Math.random()

`,l:"JavaScript/内置对象/Math.html#math-random",a:"math-random"},"87.5":{t:"Math.ceil()\r",p:`Math.ceil()函数，返回大于或等于一个给定数的最小整数。
// 舍弃小数部分，整数部分加1
Math.ceil(3.4)

`,l:"JavaScript/内置对象/Math.html#math-ceil",a:"math-ceil"},"87.6":{t:"Math.floor()\r",p:`Math.floor()方法，返回小于或等于一个给定数字的最大整数
// 舍弃小数部分，整数部分不变
Math.floor(4.68)

`,l:"JavaScript/内置对象/Math.html#math-floor",a:"math-floor"},"87.7":{t:"Math.round()\r",p:`Math.round()，返回的是一个数字四舍五入的整数。
// 取整，四舍五入原则
Math.round(5.46539)
Math.round(4.849)

`,l:"JavaScript/内置对象/Math.html#math-round",a:"math-round"},"87.8":{t:"Math.min()\r",p:`Math.min()方法，是可以返回指定一组数据中最小值。
// 找出最小值
Math.min(24, 18, 6, 19, 21)

`,l:"JavaScript/内置对象/Math.html#math-min",a:"math-min"},"87.9":{t:"Math.max()\r",p:`Math.max()方法，是可以返回指定一组数据中最大值。
// 找出最大值
Math.max(10, 21, 7, 24, 13)

`,l:"JavaScript/内置对象/Math.html#math-max",a:"math-max"},"87.10":{t:"Math.pow()\r",p:`Math.pow()方法，返回基数(base)的指数(exponent)次幂。
// 求某个数的多少次方
Math.pow(4, 2) // 求 4 的 2 次方
Math.pow(2, 3) //  ...`,l:"JavaScript/内置对象/Math.html#math-pow",a:"math-pow"},"87.11":{t:"Math.sqrt()\r",p:`Math.sqrt()方法，返回的是一个数的平方根。
// 求某数的平方根
Math.sqrt(16) // 4

`,l:"JavaScript/内置对象/Math.html#math-sqrt",a:"math-sqrt"},"87.12":{t:"Math.sin()\r",p:`Math.sin()函数，返回一个值的正弦值。
Math.sin((90 Math.PI) / 180)
// 1

`,l:"JavaScript/内置对象/Math.html#math-sin",a:"math-sin"},"87.13":{t:"Math.cos()\r",p:`Math.cos()函数，返回一个值的余弦值。
Math.cos((360 Math.PI) / 180) // 1

Math.cos(0) // 1

`,l:"JavaScript/内置对象/Math.html#math-cos",a:"math-cos"},"87.14":{t:"Math.trunc()\r",p:`Math.trunc()函数，返回的是一个数的整数部分，不管正数还是负数，直接去掉小数点及之后的部分。
Math.trunc(13.37)
// 13
Math.trunc(42.84)
// 42
 ...`,l:"JavaScript/内置对象/Math.html#math-trunc",a:"math-trunc"},"88.0":{t:"# 内置对象 Number\r",p:"\r",l:"JavaScript/内置对象/Number.html",a:"内置对象-number"},"88.1":{t:"属性\r",p:`
Number.MAX_VALUE：表示 JavaScript 中能表示的最大数值，约为 1.79 × 10^308。
Number.MIN_VALUE：表示 JavaScript 中能表示的最小正数 ...`,l:"JavaScript/内置对象/Number.html#属性",a:"属性"},"88.2":{t:"方法\r",p:`

Number.isNaN(num)：判断给定的值是否为NaN（非数值）。如果是NaN，则返回true，否则返回false。


Number.isFinite(num)：判断给定的值是否为有限数值 ...`,l:"JavaScript/内置对象/Number.html#方法",a:"方法"},"89.0":{t:"# 内置对象 RegExp\r",p:"\r",l:"JavaScript/内置对象/RegExp.html",a:"内置对象-regexp"},"89.1":{t:"什么是 RegExp？\r",p:"RegExp（正则表达式）是一种用于匹配和操作字符串模式的强大工具。它是一种模式匹配的语法，可以用来搜索、替换和提取字符串中的特定部分。在 JavaScript 中，RegExp 是一个内置的对象类型 ...",l:"JavaScript/内置对象/RegExp.html#什么是-regexp",a:"什么是-regexp"},"89.2":{t:"正则表达式基础语法\r",p:`在 JavaScript 中，正则表达式可以使用字面量形式或构造函数形式来创建。
`,l:"JavaScript/内置对象/RegExp.html#正则表达式基础语法",a:"正则表达式基础语法"},"89.3":{t:"字面量形式\r",p:`使用斜杠（/）将正则表达式模式包围起来，后面可以跟上一些修饰符（如 g、i、m）。
const pattern = /abc/

`,l:"JavaScript/内置对象/RegExp.html#字面量形式",a:"字面量形式"},"89.4":{t:"构造函数形式\r",p:`使用 RegExp 构造函数创建正则表达式，它接收两个参数：模式字符串和可选的修饰符字符串。
const pattern = new RegExp('abc')

`,l:"JavaScript/内置对象/RegExp.html#构造函数形式",a:"构造函数形式"},"89.5":{t:"元字符\r",p:`
.：匹配除换行符之外的任何单个字符。
^：匹配字符串的开头。
$：匹配字符串的结尾。
\\*：匹配前面的元素零次或多次。
+：匹配前面的元素一次或多次。
?：匹配前面的元素零次或一次。
[]：定义字符 ...`,l:"JavaScript/内置对象/RegExp.html#元字符",a:"元字符"},"89.6":{t:"正则表达式修饰符\r",p:`修饰符用于在正则表达式中添加额外的规则，影响匹配的行为。以下是常用的修饰符：

g：全局匹配，找到所有匹配项而不仅仅是第一个。
i：不区分大小写匹配。
m：多行匹配，允许 ^ 和 $ 来匹配字符串的开 ...`,l:"JavaScript/内置对象/RegExp.html#正则表达式修饰符",a:"正则表达式修饰符"},"89.7":{t:"常用的正则表达式模式\r",p:`以下是一些常用的正则表达式模式示例：

匹配字母或数字字符：/[a-zA-Z0-9]/
匹配多个字母或数字字符：/[a-zA-Z0-9]+/
匹配数字：/\\d/
匹配非数字：/\\D/
匹配空格字符：/ ...`,l:"JavaScript/内置对象/RegExp.html#常用的正则表达式模式",a:"常用的正则表达式模式"},"89.8":{t:"正则表达式方法\r",p:`JavaScript 的字符串对象提供了一些与正则表达式相关的方法来执行匹配、搜索和替换操作。
以下是一些常用的方法：

match()：在字符串中搜索匹配正则表达式的结果，并返回一个数组或 null ...`,l:"JavaScript/内置对象/RegExp.html#正则表达式方法",a:"正则表达式方法"},"89.9":{t:"正则表达式的分组和捕获\r",p:`正则表达式还支持使用圆括号进行分组和捕获。通过使用圆括号将模式的一部分括起来，可以创建子模式，并将匹配到的子串捕获到一个分组中。
以下是一些常用的分组和捕获的示例：

使用括号进行分组：(abc)+  ...`,l:"JavaScript/内置对象/RegExp.html#正则表达式的分组和捕获",a:"正则表达式的分组和捕获"},"89.10":{t:"正则表达式标志\r",p:`除了修饰符外，JavaScript 正则表达式还支持标志（Flags），用于提供更多的匹配选项。
以下是常用的正则表达式标志：

g：全局匹配，找到所有匹配项而不仅仅是第一个。
i：不区分大小写匹配。 ...`,l:"JavaScript/内置对象/RegExp.html#正则表达式标志",a:"正则表达式标志"},"89.11":{t:"应用场景\r",p:`正则表达式在 JavaScript 中具有广泛的应用场景，例如：

表单验证：使用正则表达式验证用户输入的表单数据，如邮箱、电话号码、密码等。
字符串替换：使用正则表达式进行文本替换、格式化或删除特定 ...`,l:"JavaScript/内置对象/RegExp.html#应用场景",a:"应用场景"},"90.0":{t:"# 继承、封装和多态\r",p:"\r",l:"JavaScript/面向对象/char.html",a:"继承、封装和多态"},"90.1":{t:"继承（Inheritance）：\r",p:`继承是一种对象间的关系，它允许一个对象（称为子类或派生类）继承另一个对象（称为父类或基类）的属性和方法。子类继承了父类的特性，可以通过继承来复用代码，减少重复编写。
在 JavaScript 中，可以 ...`,l:"JavaScript/面向对象/char.html#继承-inheritance",a:"继承-inheritance"},"90.2":{t:"封装（Encapsulation）：\r",p:`封装是一种将数据和方法包裹在一个单一实体中的概念，使得外部无法直接访问对象的内部实现细节。这样的设计有助于隐藏对象的复杂性，只暴露必要的接口，提高代码的可维护性和安全性。
在 JavaScript 中 ...`,l:"JavaScript/面向对象/char.html#封装-encapsulation",a:"封装-encapsulation"},"90.3":{t:"多态（Polymorphism）：\r",p:`多态是一种允许不同对象对同一方法做出不同响应的特性。这意味着可以使用相同的方法名，但针对不同对象实现不同的行为。多态有助于实现代码的灵活性和可扩展性。
在 JavaScript 中，由于其动态类型特性 ...`,l:"JavaScript/面向对象/char.html#多态-polymorphism",a:"多态-polymorphism"},"91.0":{t:"# 类和构造函数\r",p:"在 JavaScript 中，类是一种用于创建对象的模板或蓝图，而构造函数是用于创建类的实例的特殊函数。它们是面向对象编程的两种不同方式，但在 ES6（ECMAScript 6）之后，JavaScri ...",l:"JavaScript/面向对象/class.html",a:"类和构造函数"},"91.1":{t:"构造函数\r",p:"在 ES5 及其之前的版本中，JavaScript 使用构造函数来创建对象。构造函数本质上是一个普通的函数，但通常使用new关键字来实例化对象。构造函数内部使用this关键字来引用新创建的对象，并定义 ...",l:"JavaScript/面向对象/class.html#构造函数",a:"构造函数"},"91.2":{t:"类\r",p:`在 ES6 及以上的版本中，JavaScript 引入了class关键字，使得类的定义更加简洁明了。类定义了对象的结构和行为，而对象则是类的实例。类的方法在原型上定义，因此实例共享相同的方法。
示例： ...`,l:"JavaScript/面向对象/class.html#类",a:"类"},"92.0":{t:"# JavaScript 面向对象\r",p:"\r",l:"JavaScript/面向对象/index.html",a:"javascript-面向对象"},"92.1":{t:"是什么？\r",p:`JavaScript 面向对象是一种编程范式，其中程序被组织为一组对象，每个对象都有自己的状态和行为。在面向对象编程中，对象是数据和操作数据的方法的封装单元，它们通过相互之间的交互来完成特定的任务。
`,l:"JavaScript/面向对象/index.html#是什么",a:"是什么"},"92.2":{t:"特点：\r",p:`

对象： 对象是面向对象编程的核心概念。对象是一个复合的数据类型，它可以包含属性（也称为数据成员）和方法（也称为函数成员）。


类： 类是对象的模板或蓝图，它定义了对象将具有的属性和方法。类是一种 ...`,l:"JavaScript/面向对象/index.html#特点",a:"特点"},"93.0":{t:"# 实例对象与方法\r",p:"\r",l:"JavaScript/面向对象/new.html",a:"实例对象与方法"},"93.1":{t:"创建对象\r",p:"\r",l:"JavaScript/面向对象/new.html#创建对象",a:"创建对象"},"93.2":{t:"利用 `new Object` 创建对象\r",p:`var person = new Person()
person.name = '张三'
person.age = 18
person.sex = '男'
person.sayHi = functio ...`,l:"JavaScript/面向对象/new.html#利用-new-object-创建对象",a:"利用-new-object-创建对象"},"93.3":{t:"利用字面量创建对象\r",p:`var person = {
  name: '张三',
  age: 18,
  sex: '男',
  sayHi: function () {
 ...
 ...`,l:"JavaScript/面向对象/new.html#利用字面量创建对象",a:"利用字面量创建对象"},"93.4":{t:"利用构造函数创建对象\r",p:`构造函数：是一种特殊的函数，主要用来初始化对象，即为对象成员变量赋初始值，它总与 new 运算符一起使用。我们可以把对象中一些公共的属性和方法抽取出来，然后封装到这个函数里面。
::: tip 注意
 ...`,l:"JavaScript/面向对象/new.html#利用构造函数创建对象",a:"利用构造函数创建对象"},"93.5":{t:"常用方法\r",p:`
Object.assign(target, …sources)：复制一个或多个对象的属性到目标对象。
Object.create(proto, [propertiesObject])：创建一个新对象 ...`,l:"JavaScript/面向对象/new.html#常用方法",a:"常用方法"},"93.6":{t:"Object.assign(target, …sources)\r",p:`const obj1 = { a: 1 }
const obj2 = { b: 2 }
const obj3 = { c: 3 }
const mergedObj = Object.assign(ob ...`,l:"JavaScript/面向对象/new.html#object-assign-target-sources",a:"object-assign-target-sources"},"93.7":{t:"Object.create(proto, [propertiesObject])\r",p:`const myProto = { greeting: 'Hello' }
const newObj = Object.create(myProto)
console.log(newObj.greet ...`,l:"JavaScript/面向对象/new.html#object-create-proto-propertiesobject",a:"object-create-proto-propertiesobject"},"93.8":{t:"Object.entries(obj)\r",p:`const obj = { a: 1, b: 2, c: 3 }
const entries = Object.entries(obj)
console.log(entries) // [[&quot ...`,l:"JavaScript/面向对象/new.html#object-entries-obj",a:"object-entries-obj"},"93.9":{t:"Object.freeze(obj)\r",p:`const obj = { name: 'John' }

`,l:"JavaScript/面向对象/new.html#object-freeze-obj",a:"object-freeze-obj"},"93.10":{t:"Object.freeze(obj)\r",p:`obj.name = 'Jane' // 修改无效，不会影响原对象
console.log(obj.name) // John

`,l:"JavaScript/面向对象/new.html#object-freeze-obj",a:"object-freeze-obj"},"93.11":{t:"Object.getOwnPropertyDescriptor(obj, prop)\r",p:`const obj = { name: 'John' }
const descriptor = Object.getOwnPropertyDescriptor(obj, 'name')
console ...`,l:"JavaScript/面向对象/new.html#object-getownpropertydescriptor-obj-prop",a:"object-getownpropertydescriptor-obj-prop"},"93.12":{t:"Object.getOwnPropertyNames(obj)\r",p:`const obj = { name: 'John', age: 30 }
const propNames = Object.getOwnPropertyNames(obj)
console.log( ...`,l:"JavaScript/面向对象/new.html#object-getownpropertynames-obj",a:"object-getownpropertynames-obj"},"93.13":{t:"Object.getOwnPropertySymbols(obj)\r",p:`const sym = Symbol('mySymbol')
const obj = { [sym]: 'value' }
const symbols = Object.getOwnPropertyS ...`,l:"JavaScript/面向对象/new.html#object-getownpropertysymbols-obj",a:"object-getownpropertysymbols-obj"},"93.14":{t:"Object.getPrototypeOf(obj)\r",p:`const myProto = { greeting: 'Hello' }
const newObj = Object.create(myProto)
console.log(Object.getPr ...`,l:"JavaScript/面向对象/new.html#object-getprototypeof-obj",a:"object-getprototypeof-obj"},"93.15":{t:"Object.is(value1, value2)\r",p:`console.log(Object.is(5, 5)) // true
console.log(Object.is(0, -0)) // false
console.log(Object.is(Na ...`,l:"JavaScript/面向对象/new.html#object-is-value1-value2",a:"object-is-value1-value2"},"93.16":{t:"Object.keys(obj)\r",p:`const obj = { name: 'John', age: 30 }
const keys = Object.keys(obj)
console.log(keys) // [&quot;name ...`,l:"JavaScript/面向对象/new.html#object-keys-obj",a:"object-keys-obj"},"93.17":{t:"Object.seal(obj)\r",p:`const obj = { name: 'John' }

`,l:"JavaScript/面向对象/new.html#object-seal-obj",a:"object-seal-obj"},"93.18":{t:"Object.seal(obj)\r",p:`obj.age = 30 // 添加属性无效，不会影响原对象
delete obj.name // 删除属性无效，不会影响原对象
console.log(obj.name) // John
conso ...`,l:"JavaScript/面向对象/new.html#object-seal-obj",a:"object-seal-obj"},"93.19":{t:"Object.values(obj)\r",p:`const obj = { name: 'John', age: 30 }
const values = Object.values(obj)
console.log(values) // [&quo ...`,l:"JavaScript/面向对象/new.html#object-values-obj",a:"object-values-obj"},"93.20":{t:"Object.hasOwnProperty(prop)\r",p:`const obj = { name: 'John' }
console.log(obj.hasOwnProperty('name')) // true
console.log(obj.hasOwnP ...`,l:"JavaScript/面向对象/new.html#object-hasownproperty-prop",a:"object-hasownproperty-prop"},"94.0":{t:"# JavaScript 原型和原型链\r",p:`
JavaScript 原型和原型链是面向对象编程中的重要概念，用于实现继承和共享属性和方法。

`,l:"JavaScript/面向对象/prototype.html",a:"javascript-原型和原型链"},"94.1":{t:"原型（Prototype）\r",p:"在 JavaScript 中，每个对象都有一个特殊的属性__proto__（在 ES6 及以上版本中，可以使用Object.getPrototypeOf()来访问原型），它指向该对象的原型对象。原型对 ...",l:"JavaScript/面向对象/prototype.html#原型-prototype",a:"原型-prototype"},"94.2":{t:"原型链（Prototype Chain）\r",p:"原型链是由对象的原型对象构成的链式结构。当我们访问对象的属性或方法时，如果对象本身没有找到，则会继续在原型链上查找，直到找到为止。原型链的最终节点是Object.prototype，它是所有对象的根原 ...",l:"JavaScript/面向对象/prototype.html#原型链-prototype-chain",a:"原型链-prototype-chain"},"94.3":{t:"使用原型的好处\r",p:`
...
动态更新： 原型上的属性和方法是动 ...`,l:"JavaScript/面向对象/prototype.html#使用原型的好处",a:"使用原型的好处"},"94.4":{t:"注意事项\r",p:`
尽量避免直接修改原型对象，以免对其他对象产生意外的影响。
使用Object.create()和Object.setPrototypeOf()等方法来设置对象的原型，而不是直接修改__proto__属 ...`,l:"JavaScript/面向对象/prototype.html#注意事项",a:"注意事项"},"95.0":{t:"# JavaScript 严格模式\r",p:"JavaScript 严格模式（Strict Mode）是一种在 JavaScript 中启用更严格解析和错误处理的模式。它旨在帮助开发者编写更安全、规范、优化和可靠的代码，并避免一些常见的错误。严格 ...",l:"JavaScript/面向对象/strict.html",a:"javascript-严格模式"},"96.0":{t:"# this 关键字\r",p:"\r",l:"JavaScript/面向对象/this.html",a:"this-关键字"},"96.1":{t:"执行期上下文\r",p:`当函数执行时（准确来说，是在函数发生预编译的前一刻），会创建一个执行期上下文的内部对象。一个执行期上下文定义了一个函数执行时的环境。
每调用一次函数，就会创建一个新的上下文对象，他们之间是相互独立且独 ...`,l:"JavaScript/面向对象/this.html#执行期上下文",a:"执行期上下文"},"96.2":{t:"this 指向\r",p:`解析器在调用函数每次都会向函数内部传递进一个隐含的参数，这个隐含的参数就是 this，this 指向的是一个对象，这个对象我们称为函数执行的 上下文对象。
`,l:"JavaScript/面向对象/this.html#this-指向",a:"this-指向"},"96.3":{t:"ES5 函数内 this 的指向【非常重要】\r",p:`在 ES5 语法中，根据函数的调用方式的不同，this 会指向不同的对象：

1、以函数的形式（包括普通函数、定时器函数、立即执行函数）调用时，this 的指向永远都是 window。比如fun(); ...`,l:"JavaScript/面向对象/this.html#es5-函数内-this-的指向【非常重要】",a:"es5-函数内-this-的指向【非常重要】"},"96.4":{t:"ES6 箭头函数中 this 的指向\r",p:`ES6 中的箭头函数并不使用上面的准则，而是会继承外层函数调用的 this 绑定（无论 this 绑定到什么）。
var obj = {
  foo: function () {
    var ar ...`,l:"JavaScript/面向对象/this.html#es6-箭头函数中-this-的指向",a:"es6-箭头函数中-this-的指向"},"96.5":{t:"改变函数内部的 this 指向\r",p:`JS 专门为我们提供了一些方法来改变函数内部的 this 指向。常见的方法有 call()、apply()、bind() 方法。
`,l:"JavaScript/面向对象/this.html#改变函数内部的-this-指向",a:"改变函数内部的-this-指向"},"96.6":{t:"call()\r",p:"\r",l:"JavaScript/面向对象/this.html#call",a:"call"},"96.7":{t:"call() 方法的作用\r",p:`call() 方法的作用：可以调用一个函数，与此同时，它还可以改变这个函数内部的 this 指向。
call() 方法的另一个应用：可以实现继承。之所以能实现继承，其实是利用了上面的作用。
语法：
f ...`,l:"JavaScript/面向对象/this.html#call-方法的作用",a:"call-方法的作用"},"96.8":{t:"call() 方法举例\r",p:`举例 1、通过 call() 调用函数：
const obj1 = {
  nickName: 'zhangsan',
  age: 28
}
function fn1() {
  console.l ...`,l:"JavaScript/面向对象/this.html#call-方法举例",a:"call-方法举例"},"96.9":{t:"apply() 方法\r",p:"\r",l:"JavaScript/面向对象/this.html#apply-方法",a:"apply-方法"},"96.10":{t:"apply() 方法的作用\r",p:`apply() 方法的作用：可以调用一个函数，与此同时，它还可以改变这个函数内部的 this 指向。这一点，和 call()类似。
apply() 方法的应用： 由于 apply()需要传递数组，所以 ...`,l:"JavaScript/面向对象/this.html#apply-方法的作用",a:"apply-方法的作用"},"96.11":{t:"apply() 方法举例\r",p:`举例、通过 apply() 改变 this 指向：
var obj1 = {
  nickName: 'zhangsan',
  age: 28
}
...
function fn1(a) {
  cons ...`,l:"JavaScript/面向对象/this.html#apply-方法举例",a:"apply-方法举例"},"96.12":{t:"apply() 方法的巧妙应用：求数组的最大值\r",p:`我们知道，如果想要求数组中元素的最大值，数组本身是没有自带方法的。那怎么办呢？
虽然数组里没有获取最大值的方法，但是数值里有 Math.max(数字1，数字2，数字3) 方法，可以获取多个数值中的最大 ...`,l:"JavaScript/面向对象/this.html#apply-方法的巧妙应用-求数组的最大值",a:"apply-方法的巧妙应用-求数组的最大值"},"96.13":{t:"bind() 方法\r",p:"\r",l:"JavaScript/面向对象/this.html#bind-方法",a:"bind-方法"},"96.14":{t:"bind() 方法的作用\r",p:`bind() 方法不会调用函数，但是可以改变函数内部的 this 指向。
把 call()、apply()、bind()这三个方法做一下对比，你会发现：实际开发中， bind() 方法使用得最为频繁。 ...`,l:"JavaScript/面向对象/this.html#bind-方法的作用",a:"bind-方法的作用"},"97.0":{t:"# 前端导航\r",p:`&lt;!--
`,l:"nav/index.html",a:"前端导航"},"97.1":{t:" ",p:"",l:"nav/index.html#",a:""},"97.2":{t:"常用工具 -->\r",p:"&lt;NavLinks v-for=&quot;{title,items} in NAV_DATA&quot; :title='title' :items=&quot;items&quot;/&gt ...",l:"nav/index.html#常用工具",a:"常用工具"},"98.0":{t:"# Axios\r",p:"\r",l:"others/axios/index.html",a:"axios"},"98.1":{t:"什么是axios？\r",p:`Axios 是一个基于 promise 的 HTTP 库，可以用在浏览器和 node.js 中。
`,l:"others/axios/index.html#什么是axios",a:"什么是axios"},"98.2":{t:"安装\r",p:`使用npm：
npm install axios

使用cdn：


`,l:"others/axios/index.html#安装",a:"安装"},"98.3":{t:"使用\r",p:`
执行GET请求

let name = 'zs'
axios.get(\`/api/xxxx?name=\${name}\`)
  .then(function (result) {
    consol ...`,l:"others/axios/index.html#使用",a:"使用"},"98.4":{t:"拦截器\r",p:`拦截器，我们大致可以分为两类， 一类是 请求接口前的统一处理（请求拦截） 、 一类是 请求接口后的统一处理（响应拦截）
...
网络错误处理
授权错误处理
普 ...`,l:"others/axios/index.html#拦截器",a:"拦截器"},"98.5":{t:"错误处理\r",p:`axios.get('/user/12345')
  .catch(function (error) {
    if (error.response) {
      // 发出请求后，服务器用状态 ...`,l:"others/axios/index.html#错误处理",a:"错误处理"},"99.0":{t:"# 封装 axios\r",p:"\r",l:"others/axios/封装axios.html",a:"封装-axios"},"99.1":{t:"1.封装目的\r",p:`实现一个简单的封装，主要实现以下目的：
...
`,l:"others/axios/封装axios.html#_1-封装目的",a:"_1-封装目的"},"99.2":{t:"2.初始化 axios 实例\r",p:`import axios from 'axios'
let apiBaseUrl = ''
const service = axios.create({
  baseURL: apiBaseUrl,  ...`,l:"others/axios/封装axios.html#_2-初始化-axios-实例",a:"_2-初始化-axios-实例"},"99.3":{t:"3.设置请求拦截\r",p:`// 创建请求拦截
service.interceptors.request.use(
  (config) =&gt; {
    // 如果开启 token 认证
    if (serverCo ...`,l:"others/axios/封装axios.html#_3-设置请求拦截",a:"_3-设置请求拦截"},"99.4":{t:"4.设置响应拦截\r",p:`// 创建响应拦截
service.interceptors.response.use(
  (res) =&gt; {
    let data = res.data
    // 处理自己的业务逻 ...`,l:"others/axios/封装axios.html#_4-设置响应拦截",a:"_4-设置响应拦截"},"99.5":{t:"5.封装常见的方法\r",p:`//get
export function getAction(url, parameter) {
  return service({
    url: url,
    method: 'get' ...`,l:"others/axios/封装axios.html#_5-封装常见的方法",a:"_5-封装常见的方法"},"99.6":{t:"6.使用\r",p:`示例：
let param = {
    username:'zs',
    password:'123456'
}
...
// 定义接口方法
const login = (params)=&gt;p ...`,l:"others/axios/封装axios.html#_6-使用",a:"_6-使用"},"99.7":{t:"相关文章\r",p:`关于 Axios 的再再再封装，总是会有所不一样
十分钟封装一个好用的 axios，省时又省力他不香吗
前端架构带你 封装 axios，一次封装终身受益「美团后端连连点赞」
`,l:"others/axios/封装axios.html#相关文章",a:"相关文章"},"100.0":{t:"# Git基本命令使用\r",p:"\r",l:"others/git/git.html",a:"git基本命令使用"},"100.1":{t:"账户配置\r",p:`
配置全局账户，对所有 Git 仓库有效

git config --global user.name 'Your Name'
git config --global user.email 'Your ...`,l:"others/git/git.html#账户配置",a:"账户配置"},"100.2":{t:"本地基本操作\r",p:"\r",l:"others/git/git.html#本地基本操作",a:"本地基本操作"},"100.3":{t:"初始化本地库\r",p:`git init

`,l:"others/git/git.html#初始化本地库",a:"初始化本地库"},"100.4":{t:"查看状态\r",p:`git status

`,l:"others/git/git.html#查看状态",a:"查看状态"},"100.5":{t:"添加暂存区 git add\r",p:`
...
git add file1 file2 ...
 ...`,l:"others/git/git.html#添加暂存区-git-add",a:"添加暂存区-git-add"},"100.6":{t:"提交本地库 git commit\r",p:`
提交所有变更
...
提交指定文件
 ...
 ...`,l:"others/git/git.html#提交本地库-git-commit",a:"提交本地库-git-commit"},"100.7":{t:"比较差异 git diff\r",p:`
...
git diff  ...`,l:"others/git/git.html#比较差异-git-diff",a:"比较差异-git-diff"},"100.8":{t:"查看日志信息 git log\r",p:`
查看简要日志信息
...
git log -n
 ...`,l:"others/git/git.html#查看日志信息-git-log",a:"查看日志信息-git-log"},"100.9":{t:"分支命令\r",p:"\r",l:"others/git/git.html#分支命令",a:"分支命令"},"100.10":{t:"创建分支\r",p:`
基于当前分支创建分支
...
git branch 新分支 com ...`,l:"others/git/git.html#创建分支",a:"创建分支"},"100.11":{t:"查看本地分支\r",p:`git branch -v

`,l:"others/git/git.html#查看本地分支",a:"查看本地分支"},"100.12":{t:"删除分支\r",p:`
安全删除本地分支
...
`,l:"others/git/git.html#删除分支",a:"删除分支"},"100.13":{t:"切换分支\r",p:`git checkout 分支名

`,l:"others/git/git.html#切换分支",a:"切换分支"},"100.14":{t:"合并分支\r",p:`merge 和 rebase的区别有待学习实践 :worried:
...
将 A 分支合并到 B 分支，且为 ...`,l:"others/git/git.html#合并分支",a:"合并分支"},"100.15":{t:"版本穿梭与回滚\r",p:`
工作区指定文件恢复成和暂存区一样

git checkout file1 file2 ...

# tips in the Git Bash
# use &quot;git restore &lt; ...`,l:"others/git/git.html#版本穿梭与回滚",a:"版本穿梭与回滚"},"100.16":{t:"修改 commit 记录\r",p:`
...
git rebas ...`,l:"others/git/git.html#修改-commit-记录",a:"修改-commit-记录"},"100.17":{t:"远程仓库交互\r",p:"\r",l:"others/git/git.html#远程仓库交互",a:"远程仓库交互"},"100.18":{t:"git remote\r",p:`
查看所有远程仓库地址别名
...
修改别 ...`,l:"others/git/git.html#git-remote",a:"git-remote"},"100.19":{t:"git clone\r",p:`
克隆远程仓库到本地
...
`,l:"others/git/git.html#git-clone",a:"git-clone"},"100.20":{t:"git pull\r",p:`
拉取远程分支，并与本地分支合并

git pull 别名 分支名

`,l:"others/git/git.html#git-pull",a:"git-pull"},"100.21":{t:"git push\r",p:`
推送本地指定分支到仓库指定分支

git push 别名 本地分支:远程分支


如果远程分支被省略，表示将本地分支推送到与之存在追踪关系的远程分支（通常两者同名），如果该远程分支不存在，则会被新建 ...`,l:"others/git/git.html#git-push",a:"git-push"},"101.0":{t:"# git安装\r",p:"\r",l:"others/git/install.html",a:"git安装"},"101.1":{t:"**1.Git官网下载安装git客户端：https://git-scm.com/downloads/**\r",p:`\r
\r
\r`,l:"others/git/install.html#_1-git官网下载安装git客户端-https-git-scm-com-downloads",a:"_1-git官网下载安装git客户端-https-git-scm-com-downloads"},"101.2":{t:"**2.安装完成后，在空白处点鼠标右键选择“Git Bush Here” ，打开git bash命令窗口**\r",p:`\r
\r
\r`,l:"others/git/install.html#_2-安装完成后-在空白处点鼠标右键选择-git-bush-here-打开git-bash命令窗口",a:"_2-安装完成后-在空白处点鼠标右键选择-git-bush-here-打开git-bash命令窗口"},"101.3":{t:"**3.配置用户名和邮箱**\r",p:`git config —global user.name “xxx”
git config —global user.email “xxxx@xxx.com”
配置后结果：git config --l ...`,l:"others/git/install.html#_3-配置用户名和邮箱",a:"_3-配置用户名和邮箱"},"101.4":{t:"4.执行命令生成ssh pub_key\r",p:`ssh-keygen -t rsa -C &quot;XXXX@XXX.com&quot;

直接按三次回车，会生成 id_rsa.pub 文件，这个文件一般在C盘的.ssh目录下。
`,l:"others/git/install.html#_4-执行命令生成ssh-pub-key",a:"_4-执行命令生成ssh-pub-key"},"101.5":{t:"**5.打开生成后的id_rsa.pub文件，copy内容到git ssh个人设置**\r",p:`!image-20230222160826601
!image-20230222161109182
`,l:"others/git/install.html#_5-打开生成后的id-rsa-pub文件-copy内容到git-ssh个人设置",a:"_5-打开生成后的id-rsa-pub文件-copy内容到git-ssh个人设置"},"101.6":{t:"**6.本地拉取代码**\r",p:`就可以克隆ssh地址了
`,l:"others/git/install.html#_6-本地拉取代码",a:"_6-本地拉取代码"},"101.7":{t:"TortoiseGit安装\r",p:`TortoiseGit安装和配置详细说明
`,l:"others/git/install.html#tortoisegit安装",a:"tortoisegit安装"},"102.0":{t:"# 基本类型\r",p:"\r",l:"others/TypeScript/basic.html",a:"基本类型"},"102.1":{t:"字符串类型\r",p:`// 普通声明
let a: string = '123'

// 也可以使用es6的字符串模板
let str: string = \`ddd\${a}\`

`,l:"others/TypeScript/basic.html#字符串类型",a:"字符串类型"},"102.2":{t:"数字类型\r",p:`// 支持十六进制、十进制、八进制和二进制。
let notANumber: number = NaN //NaN
let num: number = 123.321 //普通数字
let infin ...`,l:"others/TypeScript/basic.html#数字类型",a:"数字类型"},"102.3":{t:"布尔类型\r",p:`let b1: boolean = true //可以直接使用布尔值
let b2: boolean = false //也可以通过函数返回布尔值

let b2: boolean = Boolean ...`,l:"others/TypeScript/basic.html#布尔类型",a:"布尔类型"},"102.4":{t:"数组\r",p:`TypeScript 像 JavaScript 一样可以操作数组元素。 有两种方式可以定义数组。 第一种，可以在元素类型后面接上 []，表示由此类型元素组成的一个数组：
let list: numbe ...`,l:"others/TypeScript/basic.html#数组",a:"数组"},"102.5":{t:"元组 Tuple\r",p:`元组类型允许表示一个已知元素数量和类型的数组，各元素的类型不必相同。如果一个方法需要返回多个值，可以把这多个值作为元组返回，而不需要创建额外的类来表示。
比如：可以定义一对值分别为string和num ...`,l:"others/TypeScript/basic.html#元组-tuple",a:"元组-tuple"},"102.6":{t:"枚举\r",p:`enum类型是对 JavaScript 标准数据类型的一个补充。使用枚举类型可以为一组数值赋予友好的名字。
枚举的值可以是数字，也可以是字符串。

数字枚举

enum Types {
  Red = ...`,l:"others/TypeScript/basic.html#枚举",a:"枚举"},"102.7":{t:"Any 任意类型\r",p:`没有强制限定哪种类型，随时切换类型都可以 我们可以对 any 进行任何操作，不需要检查类型
let value: Any
value = true // OK
value = 42 // OK
val ...`,l:"others/TypeScript/basic.html#any-任意类型",a:"any-任意类型"},"102.8":{t:"Void\r",p:`可以用 void 表示没有任何返回值的函数
function voidFn(): void {
  console.log('test void')
  // return // 不能带有return ...`,l:"others/TypeScript/basic.html#void",a:"void"},"102.9":{t:"Null 和 Undefined\r",p:`let u: undefined = undefined //定义undefined
let n: null = null //定义null

默认情况下 null 和 undefined 是所有类型 ...`,l:"others/TypeScript/basic.html#null-和-undefined",a:"null-和-undefined"},"102.10":{t:"Never\r",p:`never 类型表示的是那些永不存在的值的类型。
// 返回never的函数必须存在无法达到的终点

// 因为必定抛出异常，所以 error 将不会有返回值
function error(messa ...`,l:"others/TypeScript/basic.html#never",a:"never"},"102.11":{t:"Never 与 Void 的差异\r",p:`//void类型只是没有返回值 但本身不会出错
function Void(): void {
  console.log()
}

//只会抛出异常没有返回值
function Never(): n ...`,l:"others/TypeScript/basic.html#never-与-void-的差异",a:"never-与-void-的差异"},"102.12":{t:"联合类型\r",p:`联合类型用|分隔，表示取值可以为多种类型中的一种
// a可以为数字或者布尔类型，不能为字符串类型，
// 因为定义的联合类型只有数字和布尔值并没有字符串
let a:num|boolean
a =  ...`,l:"others/TypeScript/basic.html#联合类型",a:"联合类型"},"102.13":{t:"交叉类型\r",p:`交叉类型就是跟联合类型相反，用&amp;操作符表示，交叉类型就是两个类型必须存在
interface People {
  age: number,
  height： number
}
interf ...`,l:"others/TypeScript/basic.html#交叉类型",a:"交叉类型"},"102.14":{t:"类型断言\r",p:"通过类型断言这种方式可以告诉编译器，“相信我，我知道自己在干什么”。 类型断言好比其它语言里的类型转换，但是不进行特殊的数据检查和解构。 它没有运行时的影响，只是在编译阶段起作用。 TypeScrip ...",l:"others/TypeScript/basic.html#类型断言",a:"类型断言"},"103.0":{t:"# 类\r",p:"ES6提供了更接近传统语言的写法，引入了Class（类）这个概念，作为对象的模板。通过class关键字，可以定义类。基本上，ES6的class可以看作只是一个语法糖，它的绝大部分功能，ES5都可以做到 ...",l:"others/TypeScript/class.html",a:"类"},"103.1":{t:"基本实例\r",p:`// 类的基本定义与使用
class Person{
  // 声明属性
    name:string
    age:number
    ...
    // 构造方法
    constructor(nam ...`,l:"others/TypeScript/class.html#基本实例",a:"基本实例"},"103.2":{t:"继承\r",p:`在TypeScript 里，我们可以使用常用的面向对象模式。 基于类的程序设计中一种最基本的模式是允许使用继承来扩展现有的类。
// 类的继承
class Animal {
  run (distan ...`,l:"others/TypeScript/class.html#继承",a:"继承"},"103.3":{t:"类的修饰符\r",p:`总共有三个 public private protected
`,l:"others/TypeScript/class.html#类的修饰符",a:"类的修饰符"},"103.4":{t:"默认为 public\r",p:`使用public修饰符 可以让你定义的变量 内部访问 也可以外部访问 如果不写默认就是public
`,l:"others/TypeScript/class.html#默认为-public",a:"默认为-public"},"103.5":{t:"理解 private\r",p:`使用private修饰符 代表定义的变量私有的只能在内部访问 不能在外部访问
`,l:"others/TypeScript/class.html#理解-private",a:"理解-private"},"103.6":{t:"理解 protected\r",p:`使用protected修饰符 代表定义的变量私有的只能在内部和继承的子类中访问 不能在外部访问
class Person{
    public name:string
    private age ...`,l:"others/TypeScript/class.html#理解-protected",a:"理解-protected"},"103.7":{t:"readonly 修饰符\r",p:`你可以使用 readonly 关键字将属性设置为只读的。 只读属性必须在声明时或构造函数里被初始化。
class Person {
  readonly name: string = 'abc'
   ...`,l:"others/TypeScript/class.html#readonly-修饰符",a:"readonly-修饰符"},"103.8":{t:"static 静态属性 和 静态方法\r",p:`我们用static 定义的属性 不可以通过this 去访问 只能通过类名去调用
class Person {
  public name: string;
  static age: number = ...`,l:"others/TypeScript/class.html#static-静态属性-和-静态方法",a:"static-静态属性-和-静态方法"},"103.9":{t:"interface 定义 类\r",p:`ts interface 定义类 使用关键字 implements 后面跟interface的名字多个用逗号隔开 继承还是用extends

interface PersonClass {
    g ...`,l:"others/TypeScript/class.html#interface-定义-类",a:"interface-定义-类"},"103.10":{t:"存储器\r",p:`TypeScript 支持通过 getters/setters 来截取对对象成员的访问。 它能帮助你有效的控制对对象成员的访问。
下面来看如何把一个简单的类改写成使用 get 和 set。 首先，我们 ...`,l:"others/TypeScript/class.html#存储器",a:"存储器"},"103.11":{t:"抽象类\r",p:`抽象类做为其它派生类的基类使用。 它们一般不会直接被实例化，只能实例化实现了所有抽象方法的子类。 不同于接口，抽象类可以包含成员的实现细节。
abstract: 用abstract关键字声明的类叫做抽 ...`,l:"others/TypeScript/class.html#抽象类",a:"抽象类"},"104.0":{t:"# 函数\r",p:`
函数涉及的类型实际上指的是：函数参数和返回值的类型

`,l:"others/TypeScript/function.html",a:"函数"},"104.1":{t:"函数的类型\r",p:`js的函数
// 命名函数
function add(x, y) {
  return x + y
}
...
// 匿名函数 箭头函数
let myAdd = (x, y) =&gt; {
  retur ...`,l:"others/TypeScript/function.html#函数的类型",a:"函数的类型"},"104.2":{t:"可选参数`?`\r",p:`通过?表示该参数为可选参数
function add(x: number, y?: number): number {
  return y ? x + y : x;
}


const fn = ( ...`,l:"others/TypeScript/function.html#可选参数",a:"可选参数"},"104.3":{t:"默认参数\r",p:`function add(x: number, y: number = 20): number {
  return x + y;
}
add(10)  // 30

`,l:"others/TypeScript/function.html#默认参数",a:"默认参数"},"104.4":{t:"剩余参数\r",p:"必要参数，默认参数和可选参数有个共同点：它们表示某一个参数。 有时，你想同时操作多个参数，或者你并不知道会有多少参数传递进来。 在 JavaScript 里，你可以使用 arguments 来访问所有 ...",l:"others/TypeScript/function.html#剩余参数",a:"剩余参数"},"104.5":{t:"函数重载\r",p:`重载是方法名字相同，而参数不同，返回类型可以相同也可以不同。
// 重载函数声明
function add (x: string, y: string): string
function add (x ...`,l:"others/TypeScript/function.html#函数重载",a:"函数重载"},"105.0":{t:"# 泛型\r",p:`
指在定义函数、接口或类的时候，不预先指定具体的类型，而在使用的时候再指定具体类型的一种特性。

`,l:"others/TypeScript/generic.html",a:"泛型"},"105.1":{t:"函数泛型\r",p:"\r",l:"others/TypeScript/generic.html#函数泛型",a:"函数泛型"},"105.2":{t:"给函数加上类型\r",p:`下面这是两个函数，除了类型的不同，实现的功能是一样的。
function num(a: number, b: number): Array&lt;number&gt; {
  return [a, b ...`,l:"others/TypeScript/generic.html#给函数加上类型",a:"给函数加上类型"},"105.3":{t:"使用泛型优化\r",p:`语法为函数名字后面跟一个&lt;参数名&gt; 参数名可以随便写 例如我这儿写了 T
当我们使用这个函数的时候把参数的类型传进去就可以了 （也就是动态类型）
function Add&lt;T&gt; ...`,l:"others/TypeScript/generic.html#使用泛型优化",a:"使用泛型优化"},"105.4":{t:"多个泛型参数的函数\r",p:`一个函数可以定义多个泛型参数
function swap&lt;K, V&gt;(a: K, b: V): [K, V] {
  return [a, b]
}
const result = swap ...`,l:"others/TypeScript/generic.html#多个泛型参数的函数",a:"多个泛型参数的函数"},"105.5":{t:"泛型接口\r",p:`在定义接口时, 为接口中的属性或方法定义泛型类型 
在使用接口时, 再指定具体的泛型类型
interface KeyValue&lt;T,U&gt; {
  key: T;
  value: U;
} ...`,l:"others/TypeScript/generic.html#泛型接口",a:"泛型接口"},"105.6":{t:"泛型类\r",p:`在定义类时, 为类中的属性或方法定义泛型类型 在创建类的实例时, 再指定特定的泛型类型
class clacArray&lt;T&gt;{
    private arr:T[] = [];

    ...`,l:"others/TypeScript/generic.html#泛型类",a:"泛型类"},"105.7":{t:"泛型约束\r",p:`我们期望在一个泛型的变量上面，获取其length参数，但是，有的数据类型是没有length属性的
// 没有泛型约束
function getLen&lt;T&gt;(arg:T) {
  retur ...`,l:"others/TypeScript/generic.html#泛型约束",a:"泛型约束"},"106.0":{t:"# 初识TypeScript\r",p:`
TypeScript中文网

`,l:"others/TypeScript/index.html",a:"初识typescript"},"106.1":{t:"TS是什么？\r",p:`TS：是TypeScript的简称，是一种由微软开发的自由和开源的编程语言。它是 JavaScript 的一个超集，而且本质上向这个语言添加了可选的静态类型和基于类的面向对象编程。
`,l:"others/TypeScript/index.html#ts是什么",a:"ts是什么"},"106.2":{t:"TS和JS的关系\r",p:`对比于JS，TS是JS的超集，简单的说就是在 JavaScript 的基础上加入了类型系统，让每个参数都有明确的意义，从而带来了更加智能的提示。
相对于JS而言，TS属于强类型语言，所以对于项目而言， ...`,l:"others/TypeScript/index.html#ts和js的关系",a:"ts和js的关系"},"106.3":{t:"TS和JS的区别\r",p:`
JavaScript 属于动态编程语言，而ts 属于静态编程语言。

js：边解释边执行，错误只有在运行的时候才能发现
ts：先编译再执行，在写的时候就会发现错误了（ts不能直接执行，需要先编译成  ...`,l:"others/TypeScript/index.html#ts和js的区别",a:"ts和js的区别"},"106.4":{t:"TypeScript的优缺点\r",p:"",l:"others/TypeScript/index.html#typescript的优缺点",a:"typescript的优缺点"},"106.5":{t:"优点\r",p:`
增强代码的可维护性，尤其在大型项目的时候效果显著
友好地在编辑器里提示错误，编译阶段就能检查类型发现大部分错误
支持最新的JavaScript新特特性
周边生态繁荣，vue3已全面支持 typesc ...`,l:"others/TypeScript/index.html#优点",a:"优点"},"106.6":{t:"缺点\r",p:`
需要一定的学习成本
和一些插件库的兼容并不是特别完美，如以前在 vue2 项目里使用 typescript就并不是那么顺畅
增加前期开发的成本，毕竟你需要写更多的代码（但是便于后期的维护）

`,l:"others/TypeScript/index.html#缺点",a:"缺点"},"106.7":{t:"安装\r",p:`# 安装 typescript
...
# 编译
tsc i ...`,l:"others/TypeScript/index.html#安装",a:"安装"},"106.8":{t:"监视编译和在node下运行typescript\r",p:"",l:"others/TypeScript/index.html#监视编译和在node下运行typescript",a:"监视编译和在node下运行typescript"},"106.9":{t:"一、使用tsc -w进行随时热更新watch\r",p:`tsc -w

`,l:"others/TypeScript/index.html#一、使用tsc-w进行随时热更新watch",a:"一、使用tsc-w进行随时热更新watch"},"106.10":{t:"二、使用ts-node直接运行ts的node项目\r",p:`首先全局安装ts-node
npm install -g ts-node

直接进行ts-node 启动文件名
`,l:"others/TypeScript/index.html#二、使用ts-node直接运行ts的node项目",a:"二、使用ts-node直接运行ts的node项目"},"107.0":{t:"# 接口和对象类型\r",p:`
TypeScript 的核心原则之一是对值所具有的结构进行类型检查。我们使用接口（Interfaces）来定义对象的类型。接口是对象的状态(属性)和行为(方法)的抽象(描述)

`,l:"others/TypeScript/interface.html",a:"接口和对象类型"},"107.1":{t:"对象的类型\r",p:`在typescript中，我们定义对象的方式要用关键字interface（接口），我的理解是使用interface来定义一种约束，让数据的结构满足约束的格式。定义方式如下：
//这样写是会报错的 因为 ...`,l:"others/TypeScript/interface.html#对象的类型",a:"对象的类型"},"107.2":{t:"重名interface 会合并\r",p:`interface A{name:string}
...
`,l:"others/TypeScript/interface.html#重名interface-会合并",a:"重名interface-会合并"},"107.3":{t:"继承\r",p:`interface A {
    name:stirng
}
...
let obj:B = {
    age:18,
 ...`,l:"others/TypeScript/interface.html#继承",a:"继承"},"107.4":{t:"可选属性 使用`?`操作符\r",p:`可选属性的好处之一是可以对可能存在的属性进行预定义，好处之二是可以捕获引用了不存在的属性时的错误。
可选属性的含义是该属性可以不存在，带有可选属性的接口与普通的接口定义差不多，在可选属性名字定义的后面 ...`,l:"others/TypeScript/interface.html#可选属性-使用-操作符",a:"可选属性-使用-操作符"},"107.5":{t:"任意属性\r",p:`需要注意的是，一旦定义了任意属性，那么确定属性和可选属性的类型都必须是它的类型的子集：
//在这个例子当中我们看到接口中并没有定义C但是并没有报错
//应为我们定义了[propName: string ...`,l:"others/TypeScript/interface.html#任意属性",a:"任意属性"},"107.6":{t:"只读属性 readonly\r",p:`readonly只读属性是不允许被赋值的，只能读取
//这样写是会报错的
//应为a是只读的不允许重新赋值
interface Person {
    b?: string,
    readonl ...`,l:"others/TypeScript/interface.html#只读属性-readonly",a:"只读属性-readonly"},"107.7":{t:"添加函数\r",p:`interface Person {
    cb:()=&gt;void
}
const person: Person = {
    cb:()=&gt;{
        console.log ...`,l:"others/TypeScript/interface.html#添加函数",a:"添加函数"},"108.0":{t:"# 对象类型\r",p:`这里所说的对象类型，就是我们常说的函数、{}、数组、类
`,l:"others/TypeScript/object.html",a:"对象类型"},"108.1":{t:"object,Object 和类型\r",p:`
object

object 类型用于表示所有的非原始类型，即我们不能把 number、string、boolean、symbol 等 原始类型赋值给 object。在严格模式下，null 和 un ...`,l:"others/TypeScript/object.html#",a:""},"109.0":{t:"# tsconfig.json 配置文件\r",p:`{
  &quot;compilerOptions&quot;: {
    /* 基本选项 */

    // 指定 ECMAScript 目标版本: 'ES3' (default), 'ES5' ...`,l:"others/TypeScript/tsconfig.html",a:"tsconfig-json-配置文件"},"110.0":{t:"# 类型推论|类型别名\r",p:`\r
\r`,l:"others/TypeScript/type.html",a:"类型推论-类型别名"},"110.1":{t:"类型推论\r",p:`TypeScript里，在有些没有明确指出类型的地方，类型推论会帮助提供类型。
/* 定义变量时赋值了, 推断为对应的类型 */
let n1 = 10 // number
// 相当于 let n1 ...`,l:"others/TypeScript/type.html#类型推论",a:"类型推论"},"110.2":{t:"类型别名\r",p:`type 关键字（可以给一个类型定义一个名字）多用于复合类型
...
console.log(s ...`,l:"others/TypeScript/type.html#类型别名",a:"类型别名"},"111.0":{t:"# vue3 项目配置文档\r",p:"\r",l:"project/configuration.html",a:"vue3-项目配置文档"},"111.1":{t:"一、搭建后台管理系统模板\r",p:"\r",l:"project/configuration.html#一、搭建后台管理系统模板",a:"一、搭建后台管理系统模板"},"111.2":{t:"1.1 项目初始化\r",p:"搭建一个 vue3 版本的后台管理系统，一个项目要有统一的规范，需要使用 eslint+stylelint+prettier 来对我们的代码质量做检测和修复，需要使用 husky 来做 commit  ...",l:"project/configuration.html#_1-1-项目初始化",a:"_1-1-项目初始化"},"111.3":{t:"1.1.1 环境准备\r",p:`
node 16+
pnpm 8.3.1

`,l:"project/configuration.html#_1-1-1-环境准备",a:"_1-1-1-环境准备"},"111.4":{t:"1.1.2 初始化项目\r",p:`本项目使用 vite 进行构建，vite 官方中文文档参考：cn.vitejs.dev/guide/
pnpm:performant npm ，意味“高性能的 npm”。pnpm由 npm/yarn  ...`,l:"project/configuration.html#_1-1-2-初始化项目",a:"_1-1-2-初始化项目"},"111.5":{t:"1.2 项目配置\r",p:"\r",l:"project/configuration.html#_1-2-项目配置",a:"_1-2-项目配置"},"111.6":{t:"一、eslint 配置\r",p:`eslint 中文官网:http://eslint.cn/
ESLint 最初是由Nicholas C. Zakas 于 2013 年 6 月创建的开源项目。它的目标是提供一个插件化的javascri ...`,l:"project/configuration.html#一、eslint-配置",a:"一、eslint-配置"},"111.7":{t:"1.1.1 vue3 环境代码校验插件\r",p:`# 让所有与prettier规则存在冲突的Eslint rules失效，并使用prettier进行代码检查
&quot;eslint-config-prettier&quot;: &quot;^8.6 ...`,l:"project/configuration.html#_1-1-1-vue3-环境代码校验插件",a:"_1-1-1-vue3-环境代码校验插件"},"111.8":{t:"1.1.2 修改.eslintrc.cjs 配置文件\r",p:`// @see https://eslint.bootcss.com/docs/rules/

module.exports = {
  env: {
    browser: true,
    e ...`,l:"project/configuration.html#_1-1-2-修改-eslintrc-cjs-配置文件",a:"_1-1-2-修改-eslintrc-cjs-配置文件"},"111.9":{t:"2.5 集成 sass\r",p:"我们目前在组件内部已经可以使用 scss 样式,因为在配置 styleLint 工具的时候，项目当中已经安装过 sass sass-loader,因此我们再组件内可以使用 scss 语法！！！需要加上 ...",l:"project/configuration.html#_2-5-集成-sass",a:"_2-5-集成-sass"},"111.10":{t:"2.6 mock 数据\r",p:`安装依赖:https://www.npmjs.com/package/vite-plugin-mock
pnpm install -D vite-plugin-mock mockjs

在 vite. ...`,l:"project/configuration.html#_2-6-mock-数据",a:"_2-6-mock-数据"},"111.11":{t:"2.7 axios 二次封装\r",p:`在开发项目的时候避免不了与后端进行交互,因此我们需要使用 axios 插件实现发送网络请求。在开发项目的时候
我们经常会把 axios 进行二次封装。
目的:
1:使用请求拦截器，可以在请求拦截器中处 ...`,l:"project/configuration.html#_2-7-axios-二次封装",a:"_2-7-axios-二次封装"},"111.12":{t:"2.8 API 接口统一管理\r",p:`在开发项目的时候,接口可能很多需要统一管理。在 src 目录下去创建 api 文件夹去统一管理项目的接口；
比如:下面方式
//统一管理咱们项目用户相关的接口

import request from ...`,l:"project/configuration.html#_2-8-api-接口统一管理",a:"_2-8-api-接口统一管理"},"112.0":{t:"Nginx 部署刷新 404 问题\r",p:`location / {
root   C:\\Users....;
index  index.html index.htm;
try_files $uri $uri/ @Qrouter; // 加上这 ...`,l:"server/linux/nginx.html",a:"nginx-部署刷新-404-问题"},"112.1":{t:"Nginx部署项目\r",p:`1、 yarn build打包项目
2、 打开nginx.conf文件，配置对应的信息
3、 检查配置文件是否配置成功
nginx -t -c D:\\nginx-1.16.1\\conf\\nginx.c ...`,l:"server/linux/nginx.html#nginx部署项目",a:"nginx部署项目"},"113.0":{t:"# MySQL 数据库的常用命令\r",p:`MySQL 数据库的常用命令包括管理数据库和表的命令、数据操作命令以及授权和权限管理命令。下面列出了一些常用的 MySQL 命令：
`,l:"server/mysql/command.html",a:"mysql-数据库的常用命令"},"113.1":{t:"管理数据库和表的命令\r",p:`
CREATE DATABASE database_name;：创建一个新的数据库。
DROP DATABASE database_name;：删除一个数据库。
USE database_name;： ...`,l:"server/mysql/command.html#管理数据库和表的命令",a:"管理数据库和表的命令"},"113.2":{t:"数据操作命令\r",p:`
INSERT INTO table_name (column1, column2, ...) VALUES (value1, value2, ...);：向表中插入数据。
SELECT column ...`,l:"server/mysql/command.html#数据操作命令",a:"数据操作命令"},"113.3":{t:"授权和权限管理命令\r",p:`
GRANT privileges ON database_name.table_name TO 'username'@'hostname';：授予用户特定数据库或表的权限。
REVOKE privi ...`,l:"server/mysql/command.html#授权和权限管理命令",a:"授权和权限管理命令"},"114.0":{t:"# MySQL 字段的数据类型\r",p:`MySQL 提供了多种数据类型，用于定义表中列（字段）的数据类型。每个数据类型都有特定的存储需求和可接受的值范围。以下是 MySQL 中常用的数据类型：
`,l:"server/mysql/dataType.html",a:"mysql-字段的数据类型"},"114.1":{t:"整数类型\r",p:`
TINYINT：一个非常小的整数，范围为-128 到 127（有符号）或 0 到 255（无符号）。
SMALLINT：较小的整数，范围为-32,768 到 32,767（有符号）或 0 到 65, ...`,l:"server/mysql/dataType.html#整数类型",a:"整数类型"},"114.2":{t:"浮点数类型\r",p:`
FLOAT：单精度浮点数，范围为-3.402823466E+38 到-1.175494351E-38、0 和 1.175494351E-38 到 3.402823466E+38。
DOUBLE：双精 ...`,l:"server/mysql/dataType.html#浮点数类型",a:"浮点数类型"},"114.3":{t:"字符串类型\r",p:`
CHAR：固定长度的字符串，最大长度为 255 个字符。
VARCHAR：可变长度的字符串，最大长度为 65535 个字符。
TEXT：用于存储较长文本数据的字符串类型，最大长度为 65535 个字 ...`,l:"server/mysql/dataType.html#字符串类型",a:"字符串类型"},"114.4":{t:"日期和时间类型\r",p:`
DATE：存储日期，格式为'YYYY-MM-DD'。
TIME：存储时间，格式为'HH:MM:SS'。
DATETIME：存储日期和时间，格式为'YYYY-MM-DD HH:MM:SS'。
TIME ...`,l:"server/mysql/dataType.html#日期和时间类型",a:"日期和时间类型"},"114.5":{t:"其他常用类型\r",p:`
BOOLEAN：存储布尔值（true 或 false）。
ENUM：存储枚举值，从一个预定义的值列表中选择一个值。
SET：存储一个或多个预定义的值。

::: tip
除了上述常见的数据类型，My ...`,l:"server/mysql/dataType.html#其他常用类型",a:"其他常用类型"},"115.0":{t:"数据库概述\r",p:`数据库是用于组织和存储大量结构化数据的集合。它是一种数据管理系统，允许用户定义、创建、操作和控制访问数据的方法。数据库的设计和使用旨在提供高效的数据存储、快速的数据检索和安全的数据管理。
数据库通常由 ...`,l:"server/mysql/index.html",a:"数据库概述"},"115.1":{t:"MySQL介绍\r",p:"MySQL是一种开源的关系型数据库管理系统，由瑞典公司MySQL AB开发并最终由Oracle Corporation收购。MySQL被广泛用于各种规模的应用程序和网站，因其易用性、性能和可靠性而受到 ...",l:"server/mysql/index.html#mysql介绍",a:"mysql介绍"},"116.0":{t:"# 安装Mysql",p:"",l:"server/mysql/install.html",a:"安装mysql"},"117.0":{t:"# MySQL 基本使用\r",p:`MySQL 的基本使用包括连接到 MySQL 服务器、创建数据库、创建表、插入数据、查询数据、更新数据和删除数据等操作。下面是 MySQL 的基本使用步骤：
`,l:"server/mysql/operation.html",a:"mysql-基本使用"},"117.1":{t:"1. 连接到 MySQL 服务器\r",p:`使用 MySQL 客户端工具（如命令行客户端或图形化客户端工具）连接到 MySQL 服务器。

命令行客户端：打开命令行终端，运行命令mysql -u username -p，其中username是您 ...`,l:"server/mysql/operation.html#_1-连接到-mysql-服务器",a:"_1-连接到-mysql-服务器"},"117.2":{t:"2. 创建数据库\r",p:`在 MySQL 中创建一个新的数据库，用于存储数据。
CREATE DATABASE database_name;

将database_name替换为您希望创建的数据库的名称。
`,l:"server/mysql/operation.html#_2-创建数据库",a:"_2-创建数据库"},"117.3":{t:"3. 选择数据库\r",p:`使用以下命令选择要在其中执行操作的数据库。
USE database_name;

将database_name替换为您要使用的数据库的名称。
`,l:"server/mysql/operation.html#_3-选择数据库",a:"_3-选择数据库"},"117.4":{t:"4. 创建表\r",p:`在所选的数据库中创建一个新的表，定义表的列和数据类型。
CREATE TABLE table_name (
  column1 datatype,
  column2 datatype,
  ...
 ...`,l:"server/mysql/operation.html#_4-创建表",a:"_4-创建表"},"117.5":{t:"5. 插入数据\r",p:`使用以下命令向表中插入数据。
INSERT INTO table_name (column1, column2, ...)
VALUES (value1, value2, ...);

将table_ ...`,l:"server/mysql/operation.html#_5-插入数据",a:"_5-插入数据"},"117.6":{t:"6. 查询数据\r",p:`使用 SELECT 语句从表中检索数据。
SELECT column1, column2, ...
FROM table_name
WHERE condition;

将column1、column2 ...`,l:"server/mysql/operation.html#_6-查询数据",a:"_6-查询数据"},"117.7":{t:"7. 更新数据\r",p:`使用 UPDATE 语句更新表中的数据。
UPDATE table_name
SET column1 = value1, column2 = value2, ...
WHERE condition;
 ...`,l:"server/mysql/operation.html#_7-更新数据",a:"_7-更新数据"},"117.8":{t:"8. 删除数据\r",p:`使用 DELETE 语句从表中删除数据。
DELETE FROM table_name
WHERE condition;

将table_name替换为要删除数据的表的名称，condition替换为删 ...`,l:"server/mysql/operation.html#_8-删除数据",a:"_8-删除数据"},"118.0":{t:"# 使用 node 做一个简单的爬虫\r",p:"\r",l:"server/nodejs/crawler.html",a:"使用-node-做一个简单的爬虫"},"118.1":{t:"1. 初始化项目\r",p:`npm init -y

`,l:"server/nodejs/crawler.html#_1-初始化项目",a:"_1-初始化项目"},"118.2":{t:"2. 安装插件 cheerio\r",p:`npm install cheerio

Cheerio 解析标记并提供用于遍历/操作结果数据结构的 API。它不会像网络浏览器那样解释结果。具体来说，它不会生成视觉渲染、应用 CSS、加载外部资源或 ...`,l:"server/nodejs/crawler.html#_2-安装插件-cheerio",a:"_2-安装插件-cheerio"},"118.3":{t:"3. 访问要爬取的网站\r",p:`
爬取豆瓣网 https://movie.douban.com/top250
!img
根据浏览器检查元素区，要爬取的内容
!img

`,l:"server/nodejs/crawler.html#_3-访问要爬取的网站",a:"_3-访问要爬取的网站"},"118.4":{t:"4。 创建 index.js 文件并编写代码\r",p:`// 引入模块
const https = require('https')
const cheerio = require('cheerio')
const fs = require('fs')

 ...`,l:"server/nodejs/crawler.html#_4。-创建-index-js-文件并编写代码",a:"_4。-创建-index-js-文件并编写代码"},"118.5":{t:"5. 运行脚本\r",p:`node index.js

`,l:"server/nodejs/crawler.html#_5-运行脚本",a:"_5-运行脚本"},"118.6":{t:"6. 爬取成功\r",p:`!img
这时会多出来一个名叫files.json的 json 文件
里面就是爬取出来的内容了
[
  {
    &quot;title&quot;: &quot;肖申克的救赎 / The Shaw ...`,l:"server/nodejs/crawler.html#_6-爬取成功",a:"_6-爬取成功"},"119.0":{t:"# Express\r",p:`官网传送门

基于 Node.js 平台，快速、开放、极简的 Web 开发框架

Express 是用于快速创建服务器的第三方模块。
`,l:"server/nodejs/Express.html",a:"express"},"119.1":{t:"Express 初体验\r",p:"\r",l:"server/nodejs/Express.html#express-初体验",a:"express-初体验"},"119.2":{t:"基本使用\r",p:`安装 Express：
npm install express

创建服务器，监听客户端请求，并返回内容：
const express = require('express')
// 创建 web 服 ...`,l:"server/nodejs/Express.html#基本使用",a:"基本使用"},"119.3":{t:"托管静态资源\r",p:`
通过 express.static() 方法可创建静态资源服务器，向外开放访问静态资源。
Express 在指定的静态目录中查找文件，并对外提供资源的访问路径，存放静态文件的目录名不会出现在 URL ...`,l:"server/nodejs/Express.html#托管静态资源",a:"托管静态资源"},"119.4":{t:"Express 路由\r",p:`创建路由模块：
// router.js
...
const router = express.Router()
 ...
 ...`,l:"server/nodejs/Express.html#express-路由",a:"express-路由"},"119.5":{t:"Express 中间件\r",p:`
中间件是指流程的中间处理环节
服务器收到请求后，可先调用中间件进行预处理
中间件是一个函数，包含 req, res, next 三个参数，next() 参数把流转关系交给下一个中间件或路由

中间件 ...`,l:"server/nodejs/Express.html#express-中间件",a:"express-中间件"},"119.6":{t:"全局中间件\r",p:`
...
// 定义第一个全局中间件
 ...`,l:"server/nodejs/Express.html#全局中间件",a:"全局中间件"},"119.7":{t:"局部中间件\r",p:`const express = require('express')
const app = express()

// 定义中间件函数
const mw1 = (req, res, next) =& ...`,l:"server/nodejs/Express.html#局部中间件",a:"局部中间件"},"119.8":{t:"中间件分类\r",p:`
应用级别的中间件
...
绑定到 express.Router() ...`,l:"server/nodejs/Express.html#中间件分类",a:"中间件分类"},"119.9":{t:"CORS 跨域资源共享\r",p:"\r",l:"server/nodejs/Express.html#cors-跨域资源共享",a:"cors-跨域资源共享"},"119.10":{t:"cors 中间件解决跨域\r",p:`
安装中间件：npm install cors
导入中间件：const cors = require('cors')
配置中间件：app.use(cors())

`,l:"server/nodejs/Express.html#cors-中间件解决跨域",a:"cors-中间件解决跨域"},"119.11":{t:"CORS\r",p:`
CORS（Cross-Origin Resource Sharing，跨域资源共享）解决跨域，是通过 HTTP 响应头决定浏览器是否阻止前端 JS 代码跨域获取资源
浏览器的同源安全策略默认会阻止网 ...`,l:"server/nodejs/Express.html#cors",a:"cors"},"119.12":{t:"CORS 常见响应头\r",p:`
Access-Control-Allow-Origin：制定了允许访问资源的外域 URL

res.setHeader('Access-Control-Allow-Origin', 'http:// ...`,l:"server/nodejs/Express.html#cors-常见响应头",a:"cors-常见响应头"},"119.13":{t:"CORS 请求分类\r",p:"\r",l:"server/nodejs/Express.html#cors-请求分类",a:"cors-请求分类"},"119.14":{t:"简单请求\r",p:`
请求方式：GET、POST、HEAD 三者之一
HTTP 头部信息不超过以下几种字段：无自定义头部字段、Accept、Accept-Language、Content-Language、DPR、Dow ...`,l:"server/nodejs/Express.html#简单请求",a:"简单请求"},"119.15":{t:"预检请求\r",p:`
请求方式为 GET、POST、HEAD 之外的请求 Method 类型
请求头中包含自定义头部字段
向服务器发送了 application/json 格式的数据

在浏览器与服务器正式通信之前，浏览 ...`,l:"server/nodejs/Express.html#预检请求",a:"预检请求"},"120.0":{t:"# Nodejs 介绍\r",p:`官网传送门
`,l:"server/nodejs/index.html",a:"nodejs-介绍"},"120.1":{t:"初识 Nodejs\r",p:`
Node.js® is an open-source, cross-platform JavaScript runtime environment.
Node.js® 是一个基于 Chrome V8 ...`,l:"server/nodejs/index.html#初识-nodejs",a:"初识-nodejs"},"120.2":{t:"Nodejs 的特点\r",p:`
异步、非阻塞 IO 模型
事件循环
单线程
总结：轻量和高效
...
传统的 Java 语言是一个请求开启一个线程，当请求处理完毕后就关闭这个线程。而 Node.js ...`,l:"server/nodejs/index.html#nodejs-的特点",a:"nodejs-的特点"},"120.3":{t:"使用 Node.js 时的劣势\r",p:`
程序运行不稳定，可能会出现服务不可用的情况
程序运行效率较低，每秒的请求数维持在一个较低的水平

`,l:"server/nodejs/index.html#使用-node-js-时的劣势",a:"使用-node-js-时的劣势"},"121.0":{t:"# Nodejs内置模块\r",p:"\r",l:"server/nodejs/innerModule.html",a:"nodejs内置模块"},"121.1":{t:"fs 文件系统模块\r",p:`
fs 模块中所有的操作都有两种形式可供选择:同步和异步
同步文件系统会阻塞程序的执行，也就是除非操作完毕，否则不会向下执行代码
异步文件系统不会阻塞程序的执行，而是在操作完成时，通过回调函数将结果返 ...`,l:"server/nodejs/innerModule.html#fs-文件系统模块",a:"fs-文件系统模块"},"121.2":{t:"读取文件\r",p:"\r",l:"server/nodejs/innerModule.html#读取文件",a:"读取文件"},"121.3":{t:"简单文件读取\r",p:`语法格式：
...
encoding：编码格式
fl ...`,l:"server/nodejs/innerModule.html#简单文件读取",a:"简单文件读取"},"121.4":{t:"流式文件读取\r",p:`
简单文件读取的方式会一次性读取文件内容到内存中，若文件较大，会占用过多内存影响系统性能，且读取速度慢
大文件适合用流式文件读取，它会分多次将文件读取到内存中

var fs = require('f ...`,l:"server/nodejs/innerModule.html#流式文件读取",a:"流式文件读取"},"121.5":{t:"写入文件\r",p:"\r",l:"server/nodejs/innerModule.html#写入文件",a:"写入文件"},"121.6":{t:"简单文件写入\r",p:`语法格式：
fs.writeFile(file, data[, options], callback)


file：文件路径
data：写入内容
options：配置选项，包含 encoding,  ...`,l:"server/nodejs/innerModule.html#简单文件写入",a:"简单文件写入"},"121.7":{t:"流式文件写入\r",p:`// 同步、异步、简单文件的写入都不适合大文件的写入，性能较差，容易导致内存溢出
var fs = require('fs')

// 创建一个可写流
var ws = fs.createWriteS ...`,l:"server/nodejs/innerModule.html#流式文件写入",a:"流式文件写入"},"121.8":{t:"Buffer 缓冲区\r",p:`
Buffer 缓冲区文档


Buffer 的结构与数组类似，操作方法也与数组类似
数组不能存储二进制文件，Buffer 是专门存储二进制数据的
Buffer 存储的是二进制数据，显示时以 16 进 ...`,l:"server/nodejs/innerModule.html#buffer-缓冲区",a:"buffer-缓冲区"},"121.9":{t:"路径动态拼接问题 `__dirname`\r",p:`
在使用 fs 模块操作文件时，如果提供的操作路径是以 ./ 或 ../ 开头的相对路径时，容易出现路径动态拼接错误的问题
原因：代码在运行的时候，会以执行 node 命令时所处的目录，动态拼接出被操 ...`,l:"server/nodejs/innerModule.html#路径动态拼接问题-dirname",a:"路径动态拼接问题-dirname"},"121.10":{t:"其它操作\r",p:`验证路径是否存在：
...
fs.stat(p ...`,l:"server/nodejs/innerModule.html#其它操作",a:"其它操作"},"121.11":{t:"path 路径模块\r",p:`path 模块是 Node.js 官方提供的、用来处理路径的模块。它提供了一系列的方法和属性，用来满足用户对路径的处理需求。
`,l:"server/nodejs/innerModule.html#path-路径模块",a:"path-路径模块"},"121.12":{t:"路径拼接 `path.join()`\r",p:`const path = require('path')
const fs = require('fs')

// 注意 ../ 会抵消前面的路径
// ./ 会被忽略
const pathStr = ...`,l:"server/nodejs/innerModule.html#路径拼接-path-join",a:"路径拼接-path-join"},"121.13":{t:"获取路径中文件名 `path.basename()`\r",p:`使用 path.basename() 方法，可以获取路径中的最后一部分，常通过该方法获取路径中的文件名
path.basename(path[, ext])


path: 文件路径
ext: 文件扩 ...`,l:"server/nodejs/innerModule.html#获取路径中文件名-path-basename",a:"获取路径中文件名-path-basename"},"121.14":{t:"获取路径中文件扩展名 `path.extname()`\r",p:`const path = require('path')

const fpath = '/a/b/c/index.html'

const fext = path.extname(fpath)
co ...`,l:"server/nodejs/innerModule.html#获取路径中文件扩展名-path-extname",a:"获取路径中文件扩展名-path-extname"},"121.15":{t:"http 模块\r",p:`http 模块是 Node.js 官方提供的、用来创建 web 服务器的模块。
`,l:"server/nodejs/innerModule.html#http-模块",a:"http-模块"},"121.16":{t:"创建基本 Web 服务器\r",p:`const http = require('http')

// 创建 web 服务器实例
const server = http.createServer()

// 为服务器实例绑定 reques ...`,l:"server/nodejs/innerModule.html#创建基本-web-服务器",a:"创建基本-web-服务器"},"121.17":{t:"实现简陋路由效果\r",p:`const http = require('http')
const server = http.createServer()

server.on('request', (req, res) =&g ...`,l:"server/nodejs/innerModule.html#实现简陋路由效果",a:"实现简陋路由效果"},"122.0":{t:"# 模块化\r",p:"\r",l:"server/nodejs/module.html",a:"模块化"},"122.1":{t:"基本概念\r",p:"\r",l:"server/nodejs/module.html#基本概念",a:"基本概念"},"122.2":{t:"什么是模块化\r",p:`概念：

模块化是指解决一个复杂问题时，自顶向下逐层把系统划分为若干模块的过程，模块是可组合、分解和更换的单元。
模块化可提高代码的复用性和可维护性，实现按需加载。
模块的内部数据、实现是私有的, 只 ...`,l:"server/nodejs/module.html#什么是模块化",a:"什么是模块化"},"122.3":{t:"模块化的好处\r",p:`
避免命名空间的冲突
提高代码的复用性
提高维护性
更好的分离，实现按需加载

`,l:"server/nodejs/module.html#模块化的好处",a:"模块化的好处"},"122.4":{t:"Nodejs 中模块化\r",p:"\r",l:"server/nodejs/module.html#nodejs-中模块化",a:"nodejs-中模块化"},"122.5":{t:"Node.js 中模块的分类\r",p:`
内置模块
自定义模块
第三方模块

`,l:"server/nodejs/module.html#node-js-中模块的分类",a:"node-js-中模块的分类"},"122.6":{t:"Node.js 中的模块作用域\r",p:`
和函数作用域类似，在自定义模块中定义的变量、方法等成员，只能在当前模块内被访问，这种模块级别的访问限制，叫做模块作用域
防止全局变量污染

`,l:"server/nodejs/module.html#node-js-中的模块作用域",a:"node-js-中的模块作用域"},"122.7":{t:"模块作用域的成员\r",p:`
自定义模块中都有一个 module 对象，存储了和当前模块有关的信息
在自定义模块中，可以使用 module.exports 对象，将模块内的成员共享出去，供外界使用。导入自定义模块时，得到的就是  ...`,l:"server/nodejs/module.html#模块作用域的成员",a:"模块作用域的成员"},"122.8":{t:"CommonJS 模块化规范\r",p:`
每个模块内部，module 变量代表当前模块
module 变量是一个对象，module.exports 是对外的接口
加载某个模块即加载该模块的 module.exports 属性

`,l:"server/nodejs/module.html#commonjs-模块化规范",a:"commonjs-模块化规范"},"122.9":{t:"模块加载机制\r",p:`模块第一次加载后会被缓存，即多次调用 require() 不会导致模块的代码被执行多次，提高模块加载效率。
`,l:"server/nodejs/module.html#模块加载机制",a:"模块加载机制"},"122.10":{t:"内置模块加载\r",p:`内置模块加载优先级最高。
`,l:"server/nodejs/module.html#内置模块加载",a:"内置模块加载"},"122.11":{t:"自定义模块加载\r",p:`加载自定义模块时，路径要以 ./ 或 ../ 开头，否则会作为内置模块或第三方模块加载。
导入自定义模块时，若省略文件扩展名，则 Node.js 会按顺序尝试加载文件：

按确切的文件名加载
补全 . ...`,l:"server/nodejs/module.html#自定义模块加载",a:"自定义模块加载"},"122.12":{t:"第三方模块加载\r",p:`
若导入第三方模块， Node.js 会从当前模块的父目录开始，尝试从 /node_modules 文件夹中加载第三方模块。
如果没有找到对应的第三方模块，则移动到再上一层父目录中，进行加载，直到文件 ...`,l:"server/nodejs/module.html#第三方模块加载",a:"第三方模块加载"},"122.13":{t:"目录作为模块加载\r",p:`当把目录作为模块标识符进行加载的时候，有三种加载方式：

在被加载的目录下查找 package.json 的文件，并寻找 main 属性，作为 require() 加载的入口
如果没有 package ...`,l:"server/nodejs/module.html#目录作为模块加载",a:"目录作为模块加载"},"122.14":{t:"npm 与包\r",p:"\r",l:"server/nodejs/module.html#npm-与包",a:"npm-与包"},"122.15":{t:"包\r",p:`Node.js 中的第三方模块又叫做包
不同于 Node.js 中的内置模块与自定义模块，包是由第三方个人或团队开发出来的，免费供所有人使用。Node.js 中的包都是免费且开源的。

由于 Node ...`,l:"server/nodejs/module.html#包",a:"包"},"122.16":{t:"npm 安装\r",p:`在项目中安装包的命令
npm install 包的元整名称
或者
npm i 包的元整名称
...
下载安装速度是比 npm 要快的
`,l:"server/nodejs/module.html#npm-安装",a:"npm-安装"},"122.17":{t:"通过切换源解决 npm 的下包速度慢的问题\r",p:`npm config get registry  # 查看当前包镜像源
npm config get registry=http:registry.npm.taobao.org/ # 切换源头
npm ...`,l:"server/nodejs/module.html#通过切换源解决-npm-的下包速度慢的问题",a:"通过切换源解决-npm-的下包速度慢的问题"},"122.18":{t:"开发包\r",p:`
注册 npm 账号
初始化包的基本结构
...
index.js (包的入口文件)
README.md (包的说 ...`,l:"server/nodejs/module.html#开发包",a:"开发包"},"122.19":{t:"模块的加载机制\r",p:`模块在第一次加载后会被缓存，多次调用 require()模块的代码只会被执行一次。不论是内置模块、用户自定义模块、还是第三方模块，他们都会优先从缓存中加载，从而提高模块的加载效率。
`,l:"server/nodejs/module.html#模块的加载机制",a:"模块的加载机制"},"122.20":{t:"内置模块的加载机制\r",p:`
内置模块的加载优先级最高

`,l:"server/nodejs/module.html#内置模块的加载机制",a:"内置模块的加载机制"},"122.21":{t:"自定义模块的加载机制\r",p:`
使用 require()加载自定义模块时，必须指定以./或../开头的路径标识符。在加载自定义模块时，如果没有指定./或../这样的路径标识符，则 node 会把它当作内置模块或第三方模块进行加载。 ...`,l:"server/nodejs/module.html#自定义模块的加载机制",a:"自定义模块的加载机制"},"122.22":{t:"第三方模块的加载机制\r",p:`
如果传递给 require()的模块标识符不是一个内置模块，也没有以./或../开头，则 Nodejs 会从当前模块的父目录开始，尝试从/node_modules 文件夹中加载第三方模块
如果没有找 ...`,l:"server/nodejs/module.html#第三方模块的加载机制",a:"第三方模块的加载机制"},"122.23":{t:"目录作为模块\r",p:`
当把目录作为模块标识符，传递给 require()进行加载的时候，有三种加载方式

a. 在被加载的目录下查找一个叫做 package.json 的文件，并寻找 main 属性值作为 require ...`,l:"server/nodejs/module.html#目录作为模块",a:"目录作为模块"},"123.0":{t:"# 数据库和身份认证\r",p:"\r",l:"server/nodejs/mysql.html",a:"数据库和身份认证"},"123.1":{t:"Node 操作 mysql\r",p:"\r",l:"server/nodejs/mysql.html#node-操作-mysql",a:"node-操作-mysql"},"123.2":{t:"配置 mysql 模块\r",p:`
安装 mysql 模块
...
const db = mysql.createPool( ...`,l:"server/nodejs/mysql.html#配置-mysql-模块",a:"配置-mysql-模块"},"123.3":{t:"操作 mysql 数据库\r",p:`
查询数据
...
// ? 表示占位符
const sql  ...`,l:"server/nodejs/mysql.html#操作-mysql-数据库",a:"操作-mysql-数据库"},"123.4":{t:"Web 开发模式\r",p:"\r",l:"server/nodejs/mysql.html#web-开发模式",a:"web-开发模式"},"123.5":{t:"服务端渲染\r",p:`服务器发送给客户端的 HTML 页面，是在服务器通过字符串的拼接动态生成的。因此客户端不需要使用 Ajax 额外请求页面的数据。
app.get('/index.html', (req, res) = ...`,l:"server/nodejs/mysql.html#服务端渲染",a:"服务端渲染"},"123.6":{t:"前后端分离\r",p:`前后端分离的开发模式，依赖于 Ajax 技术的广泛应用。后端只负责提供 API 接口，前端使用 Ajax 调用接口。
优点：

开发体验好。前端专业页面开发，后端专注接口开发。
用户体验好。页面局部刷 ...`,l:"server/nodejs/mysql.html#前后端分离",a:"前后端分离"},"123.7":{t:"如何选择\r",p:`
企业级网站，主要功能是展示，没有复杂交互，且需要良好的 SEO，可考虑服务端渲染
后台管理项目，交互性强，无需考虑 SEO，可使用前后端分离
为同时兼顾首页渲染速度和前后端分离开发效率，可采用首屏服 ...`,l:"server/nodejs/mysql.html#如何选择",a:"如何选择"},"123.8":{t:"身份认证\r",p:"\r",l:"server/nodejs/mysql.html#身份认证",a:"身份认证"},"123.9":{t:"Session 认证机制\r",p:`服务端渲染推荐使用 Session 认证机制
`,l:"server/nodejs/mysql.html#session-认证机制",a:"session-认证机制"},"123.10":{t:"Session 工作原理\r",p:`!session
`,l:"server/nodejs/mysql.html#session-工作原理",a:"session-工作原理"},"123.11":{t:"Express 中使用 Session 认证\r",p:`
...
const session = require('express-sessi ...`,l:"server/nodejs/mysql.html#express-中使用-session-认证",a:"express-中使用-session-认证"},"123.12":{t:"JWT 认证机制\r",p:`前后端分离推荐使用 JWT（JSON Web Token）认证机制，是目前最流行的跨域认证解决方案
`,l:"server/nodejs/mysql.html#jwt-认证机制",a:"jwt-认证机制"},"123.13":{t:"JWT 工作原理\r",p:`Session 认证的局限性：

Session 认证机制需要配合 Cookie 才能实现。由于 Cookie 默认不支持跨域访问，所以，当涉及到前端跨域请求后端接口的时候，需要做很多额外的配置，才能 ...`,l:"server/nodejs/mysql.html#jwt-工作原理",a:"jwt-工作原理"},"123.14":{t:"Express 使用 JWT\r",p:`
安装
...
npm install jsonwebtoken expre ...`,l:"server/nodejs/mysql.html#express-使用-jwt",a:"express-使用-jwt"},"124.0":{t:"# npm 与 yarn 的命令对比\r",p:`下面是一个包含 npm 和 Yarn 命令对比的 Markdown 表格：
...
安装依赖项
npm instal ...`,l:"server/npm/command.html",a:"npm-与-yarn-的命令对比"},"125.0":{t:"# NPM：Node Package Manager（Node 包管理器）\r",p:"\r",l:"server/npm/index.html",a:"npm-node-package-manager-node-包管理器"},"125.1":{t:"什么是 npm？\r",p:`npm 是一个用于管理和共享 JavaScript 代码的工具。它是 Node.js 的默认包管理器，也是世界上最大的开源软件注册表。
npm 允许开发者轻松地安装、更新、卸载和共享 JavaScri ...`,l:"server/npm/index.html#什么是-npm",a:"什么是-npm"},"125.2":{t:"安装 npm\r",p:`npm 是随同 Node.js 一起安装的。当你安装 Node.js 时，npm 也会自动安装。
你可以通过在终端中运行以下命令来检查是否已安装 npm 并查看版本：
npm --version

如 ...`,l:"server/npm/index.html#安装-npm",a:"安装-npm"},"125.3":{t:"常用命令\r",p:`以下是一些常用的 npm 命令：

npm init：初始化一个新的 npm 项目，生成一个 package.json 文件。
npm install &lt;package-name&gt;：安装指 ...`,l:"server/npm/index.html#常用命令",a:"常用命令"},"125.4":{t:"package.json\r",p:`package.json 是每个 npm 项目的核心文件，其中包含了项目的配置信息、依赖项、脚本和其他元数据。
可以通过运行 npm init 命令来初始化一个新的项目，并生成 package.jso ...`,l:"server/npm/index.html#package-json",a:"package-json"},"125.5":{t:"使用依赖项\r",p:`使用 npm，你可以轻松地安装和管理项目的依赖项。在 package.json 文件的 dependencies 部分，你可以列出项目所需的包及其版本号。
当其他开发者获得你的项目时，他们可以使用 n ...`,l:"server/npm/index.html#使用依赖项",a:"使用依赖项"},"125.6":{t:"开发和发布包\r",p:`npm 不仅可以帮助你管理项目的依赖项，还可以帮助你开发和发布自己的包。
通过编写代码、创建 package.json 文件、定义脚本和使用 npm publish 命令，你可以将自己的包发布到 np ...`,l:"server/npm/index.html#开发和发布包",a:"开发和发布包"},"126.0":{t:"# 发布包到 npm 上\r",p:`本教程将向你展示如何发布自己的包到 npm 上。按照以下步骤进行操作：
`,l:"server/npm/publish.html",a:"发布包到-npm-上"},"126.1":{t:"步骤 1：注册 npm 账号\r",p:`如果你还没有 npm 账号，请访问 npm 官方网站（https://www.npmjs.com/）并注册一个账号。
`,l:"server/npm/publish.html#步骤-1-注册-npm-账号",a:"步骤-1-注册-npm-账号"},"126.2":{t:"步骤 2：初始化项目\r",p:`在你的项目目录中，打开终端，并执行以下命令来初始化项目：
npm init -y

`,l:"server/npm/publish.html#步骤-2-初始化项目",a:"步骤-2-初始化项目"},"126.3":{t:"步骤 3：编写代码\r",p:`在项目目录中，编写你的包的代码。可以创建一个或多个 JavaScript 文件，实现你的功能逻辑。
`,l:"server/npm/publish.html#步骤-3-编写代码",a:"步骤-3-编写代码"},"126.4":{t:"步骤 4：准备发布文件\r",p:`确保在你的项目中包含以下文件：

package.json：这个文件由 npm init 命令生成，并包含了你的包的基本信息。
README.md：这是你的包的说明文档，提供关于包的介绍、使用方法和示 ...`,l:"server/npm/publish.html#步骤-4-准备发布文件",a:"步骤-4-准备发布文件"},"126.5":{t:"步骤 5：发布包\r",p:`
使用终端登录到你的 npm 账号：
...
这将会将你的包上传到 npm 仓库，并使其对 ...`,l:"server/npm/publish.html#步骤-5-发布包",a:"步骤-5-发布包"},"126.6":{t:"步骤 6：更新和维护\r",p:`如果你的包需要更新或有新的版本，你可以按照以下步骤进行更新和维护：
...
执行以下命令发布 ...`,l:"server/npm/publish.html#步骤-6-更新和维护",a:"步骤-6-更新和维护"},"126.7":{t:"步骤 7：使用你的包\r",p:`其他开发者可以使用以下命令来安装和使用你的包：
npm install &lt;package-name&gt;

将 &lt;package-name&gt; 替换为你的包的名称。
`,l:"server/npm/publish.html#步骤-7-使用你的包",a:"步骤-7-使用你的包"},"127.0":{t:"# yarn 的安装与使用\r",p:"\r",l:"server/npm/yarn.html",a:"yarn-的安装与使用"},"127.1":{t:"安装 Yarn\r",p:`在开始之前，请确保你已经安装了 Node.js。然后，可以按照以下步骤安装 Yarn：
通过包管理器安装 Yarn：
使用 npm（全局安装）： 打开终端并运行以下命令：
npm install -g ...`,l:"server/npm/yarn.html#安装-yarn",a:"安装-yarn"},"127.2":{t:"使用 Yarn\r",p:`安装 Yarn 后，你可以使用以下常用命令来管理依赖关系和执行其他操作：


初始化项目： 进入你的项目目录，并运行以下命令来初始化项目：
yarn init

这将引导你提供有关项目的一些信息，并生 ...`,l:"server/npm/yarn.html#使用-yarn",a:"使用-yarn"},"128.0":{t:"# 创建uniapp项目\r",p:"\r",l:"smallProgram/uniapp/build.html",a:"创建uniapp项目"},"128.1":{t:"使用HBuilder-X创建\r",p:"\r",l:"smallProgram/uniapp/build.html#使用hbuilder-x创建",a:"使用hbuilder-x创建"},"128.2":{t:"使用命令行创建\r",p:`uniapp官网——创建uni-app
`,l:"smallProgram/uniapp/build.html#使用命令行创建",a:"使用命令行创建"},"129.0":{t:"# uniapp",p:"",l:"smallProgram/uniapp/index.html",a:"uniapp"},"130.0":{t:"# 初始 Canvas\r",p:"\r",l:"visual/canvas/base/初识Canvas.html",a:"初始-canvas"},"130.1":{t:"什么是 canvas？\r",p:`
Canvas 是 HTML5 中的一个元素，允许使用 JavaScript 脚本在矩形区域中绘制图像、动画和其他复杂的视觉效果。它提供了许多 API，允许控制绘图区域、颜色、线条、文本、图像等多种元 ...`,l:"visual/canvas/base/初识Canvas.html#什么是-canvas",a:"什么是-canvas"},"130.2":{t:"一. Canvas 的基础知识\r",p:"\r",l:"visual/canvas/base/初识Canvas.html#一-canvas-的基础知识",a:"一-canvas-的基础知识"},"130.3":{t:"1.1 坐标系统\r",p:"Canvas 使用直角坐标系，原点坐标为（0, 0），x 轴向右延伸，y 轴向下延伸。可以通过 Canvas API 访问 x 轴和 y 轴上的位置以及宽度和高度等信息，通过为图形或其他元素设置 x  ...",l:"visual/canvas/base/初识Canvas.html#_1-1-坐标系统",a:"_1-1-坐标系统"},"130.4":{t:"1.2 绘图上下文\r",p:"Canvas 可以绘制 SVG 和其他类型的矢量图形，但在大多数情况下，使用 Canvas 的绘图上下文进行绘制是最基本和有效的方法。Canvas API 提供了两种基本的绘图上下文，2D 和 Web ...",l:"visual/canvas/base/初识Canvas.html#_1-2-绘图上下文",a:"_1-2-绘图上下文"},"130.5":{t:"1.3 绘图元素\r",p:"Canvas 提供了多种绘图元素，包括路径和图形、文本、图像、矩形和其他形状等。绘图元素可以通过 Canvas API 进行控制，可以简单地绘制圆形、矩形、线条等图形，也可以绘制更高级的元素，如 3D ...",l:"visual/canvas/base/初识Canvas.html#_1-3-绘图元素",a:"_1-3-绘图元素"},"130.6":{t:"二. 使用 Canvas 创造交互式效果\r",p:`除了基本的绘图功能之外，Canvas 还可以创造交互式效果，用来展示和操控数据、陈述观点、以及制作各种绚丽的视觉展示等。
例如，您可以通过 Canvas 在一个网页上创造一个交互式地图，让用户点击地图 ...`,l:"visual/canvas/base/初识Canvas.html#二-使用-canvas-创造交互式效果",a:"二-使用-canvas-创造交互式效果"},"130.7":{t:"三. 使用 Canvas 创造动画\r",p:"由于 Canvas 非常适合处理像素级别的控制，利用 JavaScript 脚本使 Canvas 绘制出具有动态效果的图像和视觉艺术也显得非常合适。通过 Canvas API，您可以控制图形元素的位移 ...",l:"visual/canvas/base/初识Canvas.html#三-使用-canvas-创造动画",a:"三-使用-canvas-创造动画"},"130.8":{t:"四. Canvas 的局限性\r",p:"Canvas 虽然在 HTML5 中提供了许多优势，但也存在一些限制。例如，不同的浏览器可能解释 Canvas API 时存在差异，因此需要在开发过程中进行跨浏览器的测试。此外，在处理大量的图像和其他 ...",l:"visual/canvas/base/初识Canvas.html#四-canvas-的局限性",a:"四-canvas-的局限性"},"131.0":{t:"# Canvas 图像变换\r",p:`以下方法用于图像变换。

CanvasRenderingContext2D.rotate()：图像旋转
CanvasRenderingContext2D.scale()：图像缩放
CanvasRend ...`,l:"visual/canvas/base/图像变换.html",a:"canvas-图像变换"},"131.1":{t:"1.rotate()\r",p:`CanvasRenderingContext2D.rotate()方法用于图像旋转。它接受一个弧度值作为参数，表示顺时针旋转的度数。
context.rotate((45 * Math.PI) / 1 ...`,l:"visual/canvas/base/图像变换.html#_1-rotate",a:"_1-rotate"},"131.2":{t:"2.scale()\r",p:"CanvasRenderingContext2D.scale()方法用于缩放图像。它接受两个参数，分别是x轴方向的缩放因子和y轴方向的缩放因子。默认情况下，一个单位就是一个像素，缩放因子可以缩放单位， ...",l:"visual/canvas/base/图像变换.html#_2-scale",a:"_2-scale"},"131.3":{t:"3.translate()\r",p:`CanvasRenderingContext2D.translate()方法用于平移图像。它接受两个参数，分别是 x 轴和 y 轴移动的距离（单位像素）。
context.fillRect(0, 0, ...`,l:"visual/canvas/base/图像变换.html#_3-translate",a:"_3-translate"},"131.4":{t:"4.transform()\r",p:`CanvasRenderingContext2D.transform()方法接受一个变换矩阵的六个元素作为参数，完成缩放、旋转、移动和倾斜等变形。
它的使用格式如下。
context.transfor ...`,l:"visual/canvas/base/图像变换.html#_4-transform",a:"_4-transform"},"131.5":{t:"5.setTransform()\r",p:`CanvasRenderingContext2D.setTransform()方法取消前面的图形变换，将画布恢复到该方法指定的状态。该方法的参数与transform()方法完全一致。
context. ...`,l:"visual/canvas/base/图像变换.html#_5-settransform",a:"_5-settransform"},"132.0":{t:"# Canvas 图像合成\r",p:`
在默认情况之下，如果在 Canvas 之中将某个物体（源）绘制在另一个物体（目标）之上，那么浏览器就会简单地把源特体的图像叠放在目标物体图像上面。


在 Canvas 中，把图像源和目标图像，通过 ...`,l:"visual/canvas/base/图像合成.html",a:"canvas-图像合成"},"132.1":{t:"属性\r",p:`
...
source-in
在目标图像中显 ...`,l:"visual/canvas/base/图像合成.html#属性",a:"属性"},"133.0":{t:"# Canvas 使用\r",p:"\r",l:"visual/canvas/base/基本使用.html",a:"canvas-使用"},"133.1":{t:"使用\r",p:"&lt;canvas id=&quot;canvas&quot; width=&quot;600&quot; height=&quot;400&quot;&gt;您的浏览器不支持 Canvas&lt; ...",l:"visual/canvas/base/基本使用.html#使用",a:"使用"},"133.2":{t:"属性方法\r",p:`
strokeStyle 设置或返回描边颜色
fillStyle 设置或返回填充颜色
stroke() 描边已定义绘图（路径）
fill() 填充当前绘图（路径）
moveTo(x,y) 把路径移动到 ...`,l:"visual/canvas/base/基本使用.html#属性方法",a:"属性方法"},"134.0":{t:"# Canvas 样式控制\r",p:"\r",l:"visual/canvas/base/样式控制.html",a:"canvas-样式控制"},"134.1":{t:"1.线性\r",p:`以下的方法和属性控制线条的视觉特征。

CanvasRenderingContext2D.lineWidth：指定线条的宽度，默认为 1.0。
CanvasRenderingContext2D.lin ...`,l:"visual/canvas/base/样式控制.html#_1-线性",a:"_1-线性"},"134.2":{t:"2.渐变色\r",p:`以下方法用于设置渐变效果和图像填充效果。

CanvasRenderingContext2D.createLinearGradient()：定义线性渐变样式。
CanvasRenderingConte ...`,l:"visual/canvas/base/样式控制.html#_2-渐变色",a:"_2-渐变色"},"134.3":{t:"3.图像填充\r",p:`createPattern()方法定义一个图像填充样式，在指定方向上不断重复该图像，填充指定的区域。
context.createPattern(image, repetition)

该方法接受两个 ...`,l:"visual/canvas/base/样式控制.html#_3-图像填充",a:"_3-图像填充"},"134.4":{t:"4.阴影\r",p:`以下属性用于设置阴影。

CanvasRenderingContext2D.shadowBlur：阴影的模糊程度，默认为0。
CanvasRenderingContext2D.shadowColor： ...`,l:"visual/canvas/base/样式控制.html#_4-阴影",a:"_4-阴影"},"135.0":{t:"# Canvas 状态\r",p:`
save() 保存当前环境的状态。
restore() 返回之前保存过的路径状态和属性。

context.fillStyle = 'red'
context.fillRect(0, 0, 100, ...`,l:"visual/canvas/base/状态.html",a:"canvas-状态"},"136.0":{t:"# Canvas 绘制图形、图像、文字\r",p:"\r",l:"visual/canvas/base/绘制.html",a:"canvas-绘制图形、图像、文字"},"136.1":{t:"绘制图形\r",p:"\r",l:"visual/canvas/base/绘制.html#绘制图形",a:"绘制图形"},"136.2":{t:"绘制矩形\r",p:`//绘制矩形fillRect|strokeRect(位置x，位置y，宽度，高度)
context.strokeRect(150, 50, 100, 100) // 路径
context.fillRec ...`,l:"visual/canvas/base/绘制.html#绘制矩形",a:"绘制矩形"},"136.3":{t:"绘制圆弧\r",p:`
圆弧

// context.arc(圆心x,圆心y,半径,开始的角度,结束的角度)
// 顺时针false 逆时针true 默认值false
context.arc(300, 200, 50, 0 ...`,l:"visual/canvas/base/绘制.html#绘制圆弧",a:"绘制圆弧"},"136.4":{t:"绘制线段\r",p:`context.beginPath()
context.moveTo(100, 300)
context.lineTo(300, 300)
context.lineTo(200, 150)
conte ...`,l:"visual/canvas/base/绘制.html#绘制线段",a:"绘制线段"},"136.5":{t:"绘制图像\r",p:`
三种绘制图片的的方式

context.drawImage(image, dx, dy)
context.drawImage(image, dx, dy, dWidth, dHeight)
cont ...`,l:"visual/canvas/base/绘制.html#绘制图像",a:"绘制图像"},"136.6":{t:"绘制文本\r",p:`以下方法和属性用于绘制文本。

CanvasRenderingContext2D.fillText()：在指定位置绘制实心字符。
CanvasRenderingContext2D.strokeText ...`,l:"visual/canvas/base/绘制.html#绘制文本",a:"绘制文本"},"137.0":{t:"# Canvas 贝塞尔曲线\r",p:"\r",l:"visual/canvas/base/贝塞尔曲线.html",a:"canvas-贝塞尔曲线"},"137.1":{t:"绘制贝塞尔二次曲线\r",p:`
聊天框

context.moveTo(200, 300)
// quadraticCurveTo(控制点x,控制点y,终点x,终点y)
context.quadraticCurveTo(150,  ...`,l:"visual/canvas/base/贝塞尔曲线.html#绘制贝塞尔二次曲线",a:"绘制贝塞尔二次曲线"},"137.2":{t:"绘制贝塞尔三次曲线\r",p:`
爱心

context.moveTo(300, 120)
// bezierCurveTo(控制点1 x,控制点1 y,控制点2 x,控制点2 y,终点x,终点y)
context.bezierCu ...`,l:"visual/canvas/base/贝塞尔曲线.html#绘制贝塞尔三次曲线",a:"绘制贝塞尔三次曲线"},"138.0":{t:"# 刮刮乐\r",p:"\r",l:"visual/canvas/example/刮刮乐.html",a:"刮刮乐"},"138.1":{t:"示例\r",p:`&lt;Cbtn text='再来一次' @click='again' /&gt;
&lt;div style='height:400px'&gt;
&lt;Scratchcard v-if='sho ...`,l:"visual/canvas/example/刮刮乐.html#示例",a:"示例"},"138.2":{t:"代码\r",p:`&lt;div id=&quot;ggk&quot;&gt;谢谢惠顾&lt;/div&gt;
&lt;canvas id=&quot;myCanvas&quot; width=&quot;600&qu ...`,l:"visual/canvas/example/刮刮乐.html#代码",a:"代码"},"139.0":{t:"# 时钟\r",p:"\r",l:"visual/canvas/example/时钟.html",a:"时钟"},"139.1":{t:"示例\r",p:`&lt;Clock /&gt;
`,l:"visual/canvas/example/时钟.html#示例",a:"示例"},"139.2":{t:"代码\r",p:"\r",l:"visual/canvas/example/时钟.html#代码",a:"代码"},"139.3":{t:"js 实现\r",p:`var canvas = document.getElementById('canvas')
var context = canvas.getContext('2d')
function render ...`,l:"visual/canvas/example/时钟.html#js-实现",a:"js-实现"},"139.4":{t:"vue3 实现\r",p:`&lt;template&gt;
  &lt;div&gt;
    &lt;canvas ref=&quot;canvas&quot; width=&quot;600&quot; height=&q ...`,l:"visual/canvas/example/时钟.html#vue3-实现",a:"vue3-实现"},"140.0":{t:"# 梅花特效\r",p:`
参考视频教程

`,l:"visual/canvas/example/梅花特效.html",a:"梅花特效"},"140.1":{t:"示例\r",p:`&lt;Plum /&gt;
`,l:"visual/canvas/example/梅花特效.html#示例",a:"示例"},"140.2":{t:"代码\r",p:`&lt;template&gt;
  &lt;div&gt;
    &lt;canvas ref=&quot;canvas&quot; width=&quot;600&quot; height=&q ...`,l:"visual/canvas/example/梅花特效.html#代码",a:"代码"},"141.0":{t:"# 画板\r",p:"\r",l:"visual/canvas/example/画板.html",a:"画板"},"141.1":{t:"示例\r",p:`&lt;Draw /&gt;
`,l:"visual/canvas/example/画板.html#示例",a:"示例"},"141.2":{t:"代码\r",p:"\r",l:"visual/canvas/example/画板.html#代码",a:"代码"},"141.3":{t:"JS 实现\r",p:`&lt;button id=&quot;boldBtn&quot;&gt;粗线条&lt;/button&gt;
&lt;button id=&quot;thinBtn&quot;&gt;细线条&lt; ...`,l:"visual/canvas/example/画板.html#js-实现",a:"js-实现"},"141.4":{t:"Vue3 实现\r",p:`&lt;template&gt;
  &lt;div class=&quot;btns&quot;&gt;
    &lt;CBtn @click=&quot;boldBtn&quot; text=& ...`,l:"visual/canvas/example/画板.html#vue3-实现",a:"vue3-实现"},"142.0":{t:"<!-- # echarts -->\r",p:`该内容正在努力建设中 ......
`,l:"visual/echarts/index.html",a:"echarts"},"143.0":{t:"# PixiJs 事件交互\r",p:"\r",l:"visual/pixiJs/事件交互.html",a:"pixijs-事件交互"},"143.1":{t:"为精灵添加事件\r",p:`// 为精灵添加交互事件
sprite.interactive = true

// 精灵派加点击事件
sprite.on('click', (e) =&gt; {
  console.log(e,  ...`,l:"visual/pixiJs/事件交互.html#为精灵添加事件",a:"为精灵添加事件"},"143.2":{t:"为图形添加事件\r",p:`// 创建矩形
const rect = new PIXI.Graphics()
rect.beginFill(0xff0000)
rect.drawRect(300, 300, 150, 150)
 ...`,l:"visual/pixiJs/事件交互.html#为图形添加事件",a:"为图形添加事件"},"144.0":{t:"# 初识 PixiJs\r",p:`官方网站
`,l:"visual/pixiJs/初识PixiJs.html",a:"初识-pixijs"},"144.1":{t:"是什么\r",p:`
PixiJS 是一个基于 WebGL 和 Canvas 技术的快速、轻量级的 JavaScript 库，用于创建交互式 2D 图形和动画。它提供了简单易用的 API 和强大的渲染能力，使开发者能够轻 ...`,l:"visual/pixiJs/初识PixiJs.html#是什么",a:"是什么"},"144.2":{t:"特点\r",p:"\r",l:"visual/pixiJs/初识PixiJs.html#特点",a:"特点"},"144.3":{t:"1. 快速高效\r",p:`PixiJS 利用 WebGL 技术进行硬件加速渲染，能够处理大量的图形元素并实现流畅的动画效果。它还支持使用 Canvas 进行降级渲染，以确保在不支持 WebGL 的设备上也能正常运行。
`,l:"visual/pixiJs/初识PixiJs.html#_1-快速高效",a:"_1-快速高效"},"144.4":{t:"2. 简单易用\r",p:`PixiJS 提供了简洁而直观的 API，使开发者能够快速上手并高效地创建图形和动画。它具有一致的接口设计和详细的文档，方便开发者查阅和学习。
`,l:"visual/pixiJs/初识PixiJs.html#_2-简单易用",a:"_2-简单易用"},"144.5":{t:"3. 丰富的功能\r",p:`PixiJS 提供了一系列强大的功能，包括精灵(Sprite)、纹理(Texture)、滤镜(Filters)、事件处理等。开发者可以通过组合这些功能来创建复杂的交互式图形界面和游戏。
`,l:"visual/pixiJs/初识PixiJs.html#_3-丰富的功能",a:"_3-丰富的功能"},"144.6":{t:"4. 跨平台支持\r",p:`PixiJS 可以在现代浏览器上运行，并提供了针对移动设备的优化。它支持响应式设计，使开发者能够创建适应不同屏幕大小和分辨率的应用。
`,l:"visual/pixiJs/初识PixiJs.html#_4-跨平台支持",a:"_4-跨平台支持"},"144.7":{t:"用法示例\r",p:`下面是一个简单的 PixiJS 示例，展示了如何创建一个基本的场景并添加一个可交互的精灵：
// 创建一个场景
let app = new PIXI.Application({ width: 800, ...`,l:"visual/pixiJs/初识PixiJs.html#用法示例",a:"用法示例"},"145.0":{t:"# PixiJs 基本使用\r",p:"\r",l:"visual/pixiJs/基本使用.html",a:"pixijs-基本使用"},"145.1":{t:"使用\r",p:`&lt;template&gt;
  &lt;div&gt;&lt;/div&gt;
&lt;/template&gt;



`,l:"visual/pixiJs/基本使用.html#使用",a:"使用"},"145.2":{t:"Graphics 类详解\r",p:`// 导入pixi
import as PIXI from &quot;pixi.js&quot;;

// 创建应用
const app = new PIXI.Application({
	widt ...`,l:"visual/pixiJs/基本使用.html#graphics-类详解",a:"graphics-类详解"},"146.0":{t:"# PixiJs 文字与遮罩\r",p:"\r",l:"visual/pixiJs/文字与遮罩.html",a:"pixijs-文字与遮罩"},"146.1":{t:"添加文字\r",p:`// 导入pixi
import * as PIXI from &quot;pixi.js&quot;;

// 创建应用
const app = new PIXI.Application({
	wi ...`,l:"visual/pixiJs/文字与遮罩.html#添加文字",a:"添加文字"},"146.2":{t:"使用文字作为精灵的遮罩\r",p:`// 创建一个精灵
const sprite = PIXI.Sprite.from(
  'https://pic.rmb.bdstatic.com/05b0ea405c9e690ab51627853 ...`,l:"visual/pixiJs/文字与遮罩.html#使用文字作为精灵的遮罩",a:"使用文字作为精灵的遮罩"},"147.0":{t:"# 波纹涟漪效果\r",p:"\r",l:"visual/pixiJs/波纹涟漪效果.html",a:"波纹涟漪效果"},"147.1":{t:"代码\r",p:`&lt;template&gt;
  &lt;div&gt;&lt;/div&gt;
&lt;/template&gt;



`,l:"visual/pixiJs/波纹涟漪效果.html#代码",a:"代码"},"148.0":{t:"# PixiJs 滤镜特效\r",p:"\r",l:"visual/pixiJs/滤镜特效.html",a:"pixijs-滤镜特效"},"148.1":{t:"创建应用\r",p:`// 导入pixi
import * as PIXI from &quot;pixi.js&quot;;

// 创建应用
const app = new PIXI.Application({
	wi ...`,l:"visual/pixiJs/滤镜特效.html#创建应用",a:"创建应用"},"148.2":{t:"添加滤镜\r",p:`// 创建模糊滤镜
const blurFilter = new PIXI.BlurFilter()
// 设置模糊滤镜的模糊程度
blurFilter.blur = 10
// 将模糊滤镜添加到精灵 ...`,l:"visual/pixiJs/滤镜特效.html#添加滤镜",a:"添加滤镜"},"148.3":{t:"使用 pixi-filters 库\r",p:`npm install pixi-filters

// 创建轮廓滤镜
const outlineFilter = new OutlineFilter(5, 0xffff00) // 轮廓宽度，颜色
 ...`,l:"visual/pixiJs/滤镜特效.html#使用-pixi-filters-库",a:"使用-pixi-filters-库"},"149.0":{t:"# PixiJs 精灵与动画\r",p:"\r",l:"visual/pixiJs/精灵与动画.html",a:"pixijs-精灵与动画"},"149.1":{t:"1.创建应用\r",p:`// 导入pixi
import as PIXI from &quot;pixi.js&quot;;

// 创建应用
const app = new PIXI.Application({
	widt ...`,l:"visual/pixiJs/精灵与动画.html#_1-创建应用",a:"_1-创建应用"},"149.2":{t:"2.创建纹理与精灵\r",p:`// 创建一个纹理
const texture = PIXI.Texture.from('./vite.svg')

// 创建一个精灵
const sprite = new PIXI.Sprite( ...`,l:"visual/pixiJs/精灵与动画.html#_2-创建纹理与精灵",a:"_2-创建纹理与精灵"},"149.3":{t:"3.设置属性\r",p:`// 锚点
sprite.anchor.set(0.5, 0.5)

// 设置位置
sprite.x = app.screen.width / 2
sprite.y = app.screen.hei ...`,l:"visual/pixiJs/精灵与动画.html#_3-设置属性",a:"_3-设置属性"},"149.4":{t:"4.实现动画\r",p:`// ticker 实现动画
app.ticker.add((delta) =&gt; {
  sprite.rotation += 0.01 delta
})

`,l:"visual/pixiJs/精灵与动画.html#_4-实现动画",a:"_4-实现动画"},"150.0":{t:"# PixiJs 绘制图形\r",p:"\r",l:"visual/pixiJs/绘制图形.html",a:"pixijs-绘制图形"},"150.1":{t:"绘制椭圆\r",p:`const ellipse = new PIXI.Graphics()
ellipse.beginFill(0x66ccff)
ellipse.drawEllipse(0, 0, 164, 64)
e ...`,l:"visual/pixiJs/绘制图形.html#绘制椭圆",a:"绘制椭圆"},"150.2":{t:"绘制多边形\r",p:`const polygon = new PIXI.Graphics()
polygon.beginFill(0x660000)
// 参数一个数组，数组中的每一个元素是一个点的坐标，每两个元素是一个点 ...`,l:"visual/pixiJs/绘制图形.html#绘制多边形",a:"绘制多边形"},"150.3":{t:"创建圆角矩形\r",p:`const roundedRectangle = new PIXI.Graphics()
roundedRectangle.beginFill(0x66ccff, 0.9)

// 绘制圆角矩形 x  ...`,l:"visual/pixiJs/绘制图形.html#创建圆角矩形",a:"创建圆角矩形"},"150.4":{t:"绘制圆弧\r",p:`const arc = new PIXI.Graphics()
arc.beginFill(0x660000)
// arc(x坐标,y坐标,半径,其实角度,结束角度,顺/逆时针)
arc.arc(0 ...`,l:"visual/pixiJs/绘制图形.html#绘制圆弧",a:"绘制圆弧"},"150.5":{t:"绘制线段\r",p:`const line = new PIXI.Graphics()
line.lineStyle(10, 0x660000, 0.6) // 宽度，颜色，透明度
line.moveTo(0, 0)
li ...`,l:"visual/pixiJs/绘制图形.html#绘制线段",a:"绘制线段"},"151.0":{t:"# 谷歌恐龙小游戏\r",p:"\r",l:"visual/pixiJs/谷歌恐龙小游戏.html",a:"谷歌恐龙小游戏"},"151.1":{t:"素材图片\r",p:`!谷歌恐龙小游戏素材
`,l:"visual/pixiJs/谷歌恐龙小游戏.html#素材图片",a:"素材图片"},"151.2":{t:"代码\r",p:`&lt;template&gt;
  &lt;div&gt;app&lt;/div&gt;
&lt;/template&gt;



`,l:"visual/pixiJs/谷歌恐龙小游戏.html#代码",a:"代码"},"152.0":{t:"# PixiJs 资源管理\r",p:`
PIXI.Assets用于加载资源
使用PIXI.Container创建容器，对多个资源分组，设置容器属性即可应用到容器内的精灵

`,l:"visual/pixiJs/资源管理.html",a:"pixijs-资源管理"},"152.1":{t:"单次添加资源\r",p:`// 导入pixi
import as PIXI from &quot;pixi.js&quot;;

// 创建应用
const app = new PIXI.Application({
	widt ...`,l:"visual/pixiJs/资源管理.html#单次添加资源",a:"单次添加资源"},"152.2":{t:"一次添加多个资源\r",p:`// 导入pixi
import as PIXI from &quot;pixi.js&quot;;

// 创建应用
const app = new PIXI.Application({
	widt ...`,l:"visual/pixiJs/资源管理.html#一次添加多个资源",a:"一次添加多个资源"},"153.0":{t:"# SVG\r",p:"\r",l:"visual/svg/index.html",a:"svg"},"153.1":{t:"是什么\r",p:`
SVG 是 Scalable Vector Graphics 的缩写 意为可缩放矢量图形
SVG 是一个基于文本的开放网络标准，用来定义用于网络的矢量图形
SVG 图像在放大或改变尺寸的情况下其图形 ...`,l:"visual/svg/index.html#是什么",a:"是什么"},"153.2":{t:"基本图形\r",p:"\r",l:"visual/svg/index.html#基本图形",a:"基本图形"},"153.3":{t:"线条（line）\r",p:`&lt;svg&gt;
  &lt;!-- 不设置样式属性 style 是看不出效果的 --&gt;
  &lt;line x1=&quot;50&quot; x2=&quot;50&quot; y1 ...`,l:"visual/svg/index.html#线条-line",a:"线条-line"},"153.4":{t:"矩形（rect）\r",p:`&lt;svg&gt;
  &lt;rect x=&quot;400&quot; y=&quot;200&quot; width=&quot;150&quot; height=&quot;50&quo ...`,l:"visual/svg/index.html#矩形-rect",a:"矩形-rect"},"153.5":{t:"圆形（circle）\r",p:`&lt;svg&gt;
  &lt;circle cx=&quot;370&quot; cy=&quot;95&quot; r=&quot;50&quot; style=&quot;stroke:gr ...`,l:"visual/svg/index.html#圆形-circle",a:"圆形-circle"},"153.6":{t:"椭圆（cllipse）\r",p:`&lt;svg&gt;
  &lt;ellipse cx=&quot;100&quot; cy=&quot;100&quot; rx=&quot;100&quot; ry=&quot;50&quot; ...`,l:"visual/svg/index.html#椭圆-cllipse",a:"椭圆-cllipse"},"153.7":{t:"多边形（polygon）\r",p:`&lt;svg&gt;
  &lt;!-- 不设置样式属性style是看不出效果的 并且polygon默认为填充需要把fill属性设置为none --&gt;
  &lt;polygon
    po ...`,l:"visual/svg/index.html#多边形-polygon",a:"多边形-polygon"},"153.8":{t:"折线（polyline）\r",p:`&lt;svg&gt;
  &lt;polyline points=&quot;300 300,50 100,120 300,200,30&quot; fill-opacity=&quot;0&quo ...`,l:"visual/svg/index.html#折线-polyline",a:"折线-polyline"},"153.9":{t:"路径（path）\r",p:`&lt;svg&gt;
  &lt;path
    fill-opacity=&quot;0&quot;
    stroke=&quot;skyblue&quot;
    d=&quot;
   ...`,l:"visual/svg/index.html#路径-path",a:"路径-path"},"154.0":{t:"# 初识 ThreeJs\r",p:`
Three.js 学习指南
Three.js 中文官方文档

Three.js 是一种用于在 Web 浏览器中创建交互式 3D 图形的 JavaScript 库。它允许开发人员在 Web 应用程序中 ...`,l:"visual/threejs/base/index.html",a:"初识-threejs"},"155.0":{t:"# 渲染场景和物体\r",p:`\r
\r
\r`,l:"visual/threejs/base/渲染场景和物体.html",a:"渲染场景和物体"},"155.1":{t:"渲染第一个场景和物体\r",p:"\r",l:"visual/threejs/base/渲染场景和物体.html#渲染第一个场景和物体",a:"渲染第一个场景和物体"},"155.2":{t:"示例\r",p:`&lt;Scene1 /&gt;
`,l:"visual/threejs/base/渲染场景和物体.html#示例",a:"示例"},"155.3":{t:"代码\r",p:`:::code-group
&lt;&lt;&lt; @/visual/threejs/components/Scene1.vue[完整代码]
:::
`,l:"visual/threejs/base/渲染场景和物体.html#代码",a:"代码"},"155.4":{t:"轨道控制器查看物体\r",p:"\r",l:"visual/threejs/base/渲染场景和物体.html#轨道控制器查看物体",a:"轨道控制器查看物体"},"155.5":{t:"示例\r",p:`&lt;Scene2 /&gt;
`,l:"visual/threejs/base/渲染场景和物体.html#示例",a:"示例"},"155.6":{t:"导入轨道控制器\r",p:`import { OrbitControls } from 'three/examples/jsm/controls/OrbitControls'

`,l:"visual/threejs/base/渲染场景和物体.html#导入轨道控制器",a:"导入轨道控制器"},"155.7":{t:"创建轨道控制器\r",p:`// 创建轨道控制器
const controls = new OrbitControls(camera, renderer.domElement)

`,l:"visual/threejs/base/渲染场景和物体.html#创建轨道控制器",a:"创建轨道控制器"},"155.8":{t:"每一帧根据控制器更新画面\r",p:`function render() {
  //如果后期需要控制器带有阻尼效果，或者自动旋转等效果，就需要加入controls.update()
  controls.update()
  rende ...`,l:"visual/threejs/base/渲染场景和物体.html#每一帧根据控制器更新画面",a:"每一帧根据控制器更新画面"},"155.9":{t:"代码\r",p:`:::code-group
&lt;&lt;&lt; @/visual/threejs/components/Scene2.vue#snippet{js}[示例]
&lt;&lt;&lt; @/vis ...`,l:"visual/threejs/base/渲染场景和物体.html#代码",a:"代码"},"155.10":{t:"坐标轴辅助器\r",p:"\r",l:"visual/threejs/base/渲染场景和物体.html#坐标轴辅助器",a:"坐标轴辅助器"},"155.11":{t:"示例\r",p:`&lt;Scene /&gt;
`,l:"visual/threejs/base/渲染场景和物体.html#示例",a:"示例"},"155.12":{t:"代码\r",p:`:::code-group
&lt;&lt;&lt; @/visual/threejs/components/Scene.vue#snippet{js}[示例]
&lt;&lt;&lt; @/visu ...`,l:"visual/threejs/base/渲染场景和物体.html#代码",a:"代码"},"156.0":{t:"# 物体的缩放、位移和旋转\r",p:`\r
\r
\r`,l:"visual/threejs/base/缩放、位移和旋转.html",a:"物体的缩放、位移和旋转"},"156.1":{t:"缩放\r",p:`//例如设置x轴放大3倍、y轴方向放大2倍、z轴方向不变
cube.scale.set(3, 2, 1)
//单独设置某个轴的缩放
cube.scale.x = 3

`,l:"visual/threejs/base/缩放、位移和旋转.html#缩放",a:"缩放"},"156.2":{t:"位移\r",p:`cube.position.set(1, 2, 3)

//单独设置某个轴的位移
cube.position.x = 3

`,l:"visual/threejs/base/缩放、位移和旋转.html#位移",a:"位移"},"156.3":{t:"旋转\r",p:`//直接设置旋转属性，例如围绕x轴旋转90度
cube.rotation.x = -Math.PI / 4

//围绕x轴旋转45度
cube.rotation.set(-Math.PI / 4, 0 ...`,l:"visual/threejs/base/缩放、位移和旋转.html#旋转",a:"旋转"},"156.4":{t:"效果\r",p:`&lt;transForm /&gt;
`,l:"visual/threejs/base/缩放、位移和旋转.html#效果",a:"效果"},"156.5":{t:"代码\r",p:`:::code-group
&lt;&lt;&lt; @/visual/threejs/components/transForm.vue{45-58,77-87 vue:line-numbers}[完 ...`,l:"visual/threejs/base/缩放、位移和旋转.html#代码",a:"代码"},"157.0":{t:"# VitePress 从 0 开始搭建个人网站\r",p:`
lemon's blog 从无到有的过程
VitePress 官方网站
VitePress 中文网

`,l:"vitepress.html",a:"vitepress-从-0-开始搭建个人网站"},"157.1":{t:"一、 创建项目\r",p:`
...
`,l:"vitepress.html#一、-创建项目",a:"一、-创建项目"},"157.2":{t:"初始化项目\r",p:`npm init -y
...
&quot;scripts&quo ...`,l:"vitepress.html#初始化项目",a:"初始化项目"},"157.3":{t:"npx 创建项目\r",p:`npx create-vitepress my-site

cd my-site
npm install  或 yarn install
npm run dev  或 yarn dev

`,l:"vitepress.html#npx-创建项目",a:"npx-创建项目"},"157.4":{t:"本地运行\r",p:`
运行
...
!img
`,l:"vitepress.html#本地运行",a:"本地运行"},"157.5":{t:"二、 基本配置\r",p:"\r",l:"vitepress.html#二、-基本配置",a:"二、-基本配置"},"157.6":{t:"目录结构\r",p:"在目录下新建 docs 文件夹，在其中新建.vitepress 文件夹和 config.js 文件，config.js 文件就是我们的配置文件，新建一个 index.html 作为我们的主页，在新建一 ...",l:"vitepress.html#目录结构",a:"目录结构"},"157.7":{t:"1. 配置首页\r",p:`vitepress 支持用户使用 yaml 配置页面的内容，在 docs/index.html 写下如下内容，更多配置请查看
---
layout: home

title: 选项卡标题
titleT ...`,l:"vitepress.html#_1-配置首页",a:"_1-配置首页"},"157.8":{t:"2. 配置网站\r",p:"\r",l:"vitepress.html#_2-配置网站",a:"_2-配置网站"},"157.9":{t:"配置导航栏部分\r",p:`在 config.js 中可以开始我们的配置，先写上如下内容，这是网站的标题和描述，标题会在浏览器标签上展示
export default defineConfig({
  base: '/docs/ ...`,l:"vitepress.html#配置导航栏部分",a:"配置导航栏部分"},"157.10":{t:"配置侧边栏部分\r",p:`themeConfig: {
  // ...省略前面的内容
  // 侧边栏
  sidebar: {
    &quot;/articles/other&quot;: [
      {
     ...`,l:"vitepress.html#配置侧边栏部分",a:"配置侧边栏部分"},"157.11":{t:"三、 部署到 github.io\r",p:`新建脚本文件 deploy.sh，与 docs 文件夹处于同一级
#!/usr/bin/env sh
